...
const es: Dict = {
  ...
  "home.heroSubtitle": "Una guía paso a paso para revisar daños estructurales después de un terremoto. Sin registro. Funciona con poca señal.",
  ...
  "methodology.encyclopediaTitle": "Explora la Enciclopedia",
  "methodology.encyclopediaBody": "Guías claras sobre sismos en Venezuela, qué hacer después de un temblor y cómo revisar tu vivienda.",
  "methodology.encyclopediaCta": "Ir a la Enciclopedia",
  ...
  "engineers.tagline": "Después de tu evaluación, puedes pedir ayuda de un ingeniero voluntario, sin costo.",
  "engineers.homeBody": "Cuando una familia lo pide tras su autoevaluación, la conectamos con un ingeniero civil voluntario. Súmate para acompañar a más comunidades.",
  "engineers.recruit": "Reclutamos",
  "engineers.recruitDesc": "Convocamos a ingenieros voluntarios y organizaciones en todo el país.",
  "engineers.validate": "Validamos",
  "engineers.validateDesc": "Revisamos su experiencia antes de sumarlos como voluntarios registrados.",
  "engineers.connect": "Conectamos",
  "engineers.connectDesc": "Cuando una familia lo solicita tras su autoevaluación, la enlazamos con un ingeniero voluntario registrado que la orienta por videollamada y, si hace falta, en persona. Sin costo.",
  "engineers.learnMore": "Únete como ingeniero voluntario",
  "engineers.mapNote": "Tras una evaluación, los residentes pueden pedir apoyo de un ingeniero voluntario registrado.",
  ...
  "engineers.methodologyBody": "La autoevaluación es el primer paso. Además, reclutamos y registramos a ingenieros voluntarios y organizaciones, y conectamos a los residentes que lo solicitan con un profesional voluntario registrado para confirmar o ajustar el resultado.",
  "disclaimer.title": "Aviso importante",
  "disclaimer.body": "Esta herramienta ofrece una orientación preliminar y no sustituye la inspección de un ingeniero estructural autorizado ni de Protección Civil. Ante peligro inminente, evacúa y llama a emergencias.",
  ...
  "legal.intro": "EvalúaYa es una iniciativa comunitaria sin fines de lucro. Antes de usar la herramienta o de conectarte con un ingeniero voluntario, lee cómo funciona y cuáles son sus límites.",
  "legal.s1.title": "No reemplaza una visita oficial",
  "legal.s1.body": "Ni esta herramienta ni el contacto con un ingeniero voluntario reemplazan la inspección formal de un ingeniero estructural colegiado, de FUNVISIS o de Protección Civil. El resultado es solo informativo y no constituye un certificado de habitabilidad ni un dictamen oficial.",
  "legal.s2.title": "Es una orientación técnica preliminar",
  "legal.s2.body": "Cualquier evaluación —automática o realizada por un ingeniero voluntario— es una orientación preliminar basada en lo que se reporta y observa a simple vista. No analiza elementos ocultos, fundaciones enterradas ni el interior de los muros, y no sustituye un estudio estructural detallado.",
  "legal.s3.title": "Ingenieros voluntarios",
  "legal.s3.body": "Los ingenieros y organizaciones que participan lo hacen de forma voluntaria y gratuita. EvalúaYa no les paga ni mantiene una relación laboral o comercial con ellos; actúan a título personal. Registramos la información que nos suministran, pero no verificamos ni garantizamos sus credenciales, sus servicios ni el resultado de sus recomendaciones.",
  "legal.s4.title": "Limitación de responsabilidad",
  "legal.s4.body": "EvalúaYa, sus colaboradores y los ingenieros voluntarios no se hacen responsables por las recomendaciones dadas, las decisiones tomadas a partir de ellas, ni por daños o perjuicios derivados del uso de la aplicación. La decisión final y la responsabilidad sobre el inmueble corresponden a su propietario u ocupante y a las autoridades competentes.",
  "legal.s5.title": "Emergencias",
  "legal.s5.body": "Ante peligro inminente, no esperes una evaluación: evacúa de inmediato y llama a Protección Civil o a los servicios de emergencia.",
  "legal.contact.title": "Contacto",
  "legal.contact.body": "¿Dudas sobre este aviso? Escríbenos a contacto@evaluaya.app. Consulta también nuestra Política de privacidad.",
  "legal.short": "Orientación preliminar de voluntarios; no reemplaza una inspección oficial. Los ingenieros son voluntarios no remunerados y EvalúaYa no se responsabiliza por sus recomendaciones.",
  "legal.readMore": "Leer el aviso legal completo",
  "legal.ack": "Entiendo que esto es una orientación preliminar de voluntarios no remunerados y que no reemplaza una inspección oficial.",
  "gate.title": "Antes de continuar",
  "gate.subtitle": "EvalúaYa es una iniciativa privada, comunitaria y sin fines de lucro. Lee y acepta para usar la herramienta.",
  "gate.c1.title": "No es un organismo oficial",
  "gate.c1.body": "Iniciativa independiente y comunitaria, sin vinculación con FUNVISIS, Protección Civil, Bomberos ni ningún organismo gubernamental.",
  "gate.c2.title": "No emite dictámenes técnicos",
  "gate.c2.body": "La herramienta procesa solo hallazgos visuales preliminares y referenciales. No emite certificados de habitabilidad, dictámenes estructurales ni autorizaciones de ingreso.",
  "gate.c3.title": "Fuerza mayor y factores ambientales",
  "gate.c3.body": "No nos responsabilizamos por daños derivados de réplicas sísmicas, factores ambientales o eventos posteriores. El uso de la información es bajo riesgo del usuario.",
  "gate.accept": "He leído y acepto el aviso legal y la exención de responsabilidad.",
  ...
  "property.buildingNameHint": "Opcional. Ayuda a agrupar reportes del mismo edificio en el mapa. No incluyas el número de apartamento.",
  ...
  "property.behalfHint": "¿No puedes entrar al edificio? Un familiar o vecino puede hacer esta inspección por ti y compartirte el resultado.",
  ...
  "property.structuralType.help": "Si no estás seguro, déjalo en “No estoy seguro”.",
  ...
  "property.struct.URM.desc": "Paredes de bloque o ladrillo sin columnas ni vigas de concreto que las sostengan.",
  ...
  "property.struct.CIW.desc": "Columnas y vigas de concreto con paredes de bloque entre ellas.",
  ...
  "property.struct.RML.desc": "Paredes de bloque/ladrillo con refuerzo de acero, pocos pisos.",
  ...
  "checklist.photoHint": "Una foto no es obligatoria, pero mejora mucho el análisis. Puedes usar fotos que ya tengas.",
  ...
  "checklist.optionalNote": "Mientras más respondas, más preciso será el análisis. Las preguntas opcionales puedes omitirlas.",
  ...
  "item.liquefaction.q": "¿Hay señales de licuefacción del suelo? (agua y arena brotando, charcos donde no había agua, grietas grandes en suelo inclinado, tuberías o tanques que salieron a la superficie, o estructuras hundidas o inclinadas)",
  "item.exterior_walls.area": "Muros exteriores",
  "item.exterior_walls.q": "¿Hay grietas diagonales o separación respecto a edificios vecinos?",
  "item.pounding.area": "Golpeteo entre edificios",
  "item.pounding.q": "¿El edificio chocó o golpeó contra una edificación vecina durante el sismo?",
  "item.interior_walls.area": "Muros interiores",
  "item.interior_walls.q": "¿Hay grietas más anchas de 1 cm?",
  "item.flooring.area": "Pisos",
  "item.flooring.q": "¿Hay pisos pandeados, baldosas levantadas o nuevos espacios entre el piso y el rodapié?",
  "item.plumbing.area": "Plomería / gas",
  "item.plumbing.q": "¿Hay tuberías con fugas, grietas o separadas? ¿Escuchas agua corriendo o hueles gas? (Si hueles gas, cierra la llave principal)",
  "item.electrical.area": "Electricidad",
  "item.electrical.q": "¿Hay breakers disparados, tomacorrientes dañados o cables expuestos?",
  "item.fixtures.area": "Lámparas / accesorios",
  "item.fixtures.q": "¿Hay lámparas colgando torcidas o cajas eléctricas separadas por el sismo?",
  "item.columns_beams.area": "Columnas / vigas",
  "item.columns_beams.q": "¿Hay concreto desprendido (descascarado) o acero (cabilla) expuesto?",
  ...
  "item.walls.q": "¿Aparecieron grietas nuevas en las paredes (en diagonal, en X, o más anchas que tu dedo meñique)?",
  "item.walls.example.yes": "Grietas nuevas en diagonal o en forma de X, o tan anchas que entra tu dedo meñique.",
  "item.walls.example.no": "Solo líneas finas como un cabello, o ninguna grieta nueva.",
  "item.columns.area": "Columnas y vigas",
  "item.columns.q": "¿Hay columnas o vigas con concreto desprendido (descascarado), acero (cabilla) a la vista, o grietas marcadas?",
  "item.columns.example.yes": "El concreto de una columna o viga se descascaró y se ve la cabilla, o tiene grietas fuertes.",
  "item.columns.example.no": "Columnas y vigas lisas, sin concreto caído ni acero a la vista.",
  "item.openings.area": "Puertas y ventanas",
  "item.openings.q": "¿Hay puertas o ventanas que ya no abren o cierran porque el marco se deformó?",
  "item.openings.example.yes": "Una puerta o ventana que antes abría ahora se traba o no cierra porque el marco quedó torcido.",
  "item.openings.example.no": "Puertas y ventanas abren y cierran como siempre.",
  "item.tilt.area": "Inclinación / desplome",
  "item.tilt.q": "¿El edificio o algún piso se ve inclinado, desplomado o hundido respecto a antes?",
  "item.tilt.example.yes": "La edificación se ve recostada o inclinada, un piso quedó chueco, o una parte se hundió.",
  "item.tilt.example.no": "La edificación sigue recta y a nivel, igual que antes del sismo.",
  "checklist.severeTitle": "Otras señales a revisar",
  "checklist.severeSubtitle": "Opcional. Si viste alguna de estas con este sismo, márcala. Nos ayuda a entender mejor el caso. Si no viste ninguna, continúa.",
  ...
  "checklist.photosIntro": "Las fotos son lo más importante: son los ojos del ingeniero. Sin ellas no puede ayudarte. Toma fotos nítidas, con buena luz y bien enfocadas.",
  "checklist.facadeTitle": "Fotos de la fachada",
  "checklist.facadeHelp": "Agrega de 1 a 5 fotos del edificio completo desde afuera. Si no entra en una sola toma, hazlo desde varios ángulos. Ayuda a ver si quedó inclinado sin tener que entrar.",
  "checklist.facadeCount": "{n} de {max} fotos",
  "checklist.damageTitle": "Fotos de los daños",
  "checklist.damageHelp": "Agrega fotos claras de lo que viste. Para cada daño, una toma de lejos (el elemento completo) y una de cerca. Mínimo {min}, hasta {max}.",
  ...
  "checklist.usefulIntro": "Así se ve una foto útil. Tómalas pensando en lo que el ingeniero necesita ver:",
  "checklist.usefulEx.scale.title": "Con referencia de tamaño",
  "checklist.usefulEx.scale.desc": "Pon una mano, moneda o regla al lado de la grieta para ver el ancho.",
  "checklist.usefulEx.rebar.title": "Concreto y cabilla a la vista",
  "checklist.usefulEx.rebar.desc": "En columnas y vigas, muestra el concreto desprendido y el acero expuesto.",
  "checklist.usefulEx.joint.title": "Uniones y esquinas",
  "checklist.usefulEx.joint.desc": "Donde se juntan pared, columna y techo suele verse el daño real.",
  "checklist.usefulEx.wideClose.title": "De lejos y de cerca",
  "checklist.usefulEx.wideClose.desc": "La fachada completa desde lejos (todo el edificio) más una toma cercana del detalle. La foto de lejos es la más útil para el ingeniero.",
  ...
  "checklist.commentsHint": "Cuéntale al ingeniero lo que las fotos no muestran: materiales, cuándo apareció el daño, algo fuera de lo normal.",
  "checklist.commentsPlaceholder": "Ej.: El edificio es de bloque. Una grieta en la sala apareció justo después del sismo y sigue creciendo. Cae agua del techo.",
  "checklist.signalsTitle": "Marca lo que aplique (opcional)",
  "checklist.signalsHint": "Esto ayuda al ingeniero a priorizar tu caso. Marca solo lo que sea cierto.",
  "checklist.suggest.aftershock": "Hubo réplicas fuertes después del sismo",
  "checklist.suggest.noises": "Se escuchan crujidos o ruidos nuevos en la estructura",
  "checklist.suggest.common": "Hay daños en áreas comunes (escaleras, ascensor, tanque, estacionamiento)",
  "checklist.suggest.people": "Hay personas mayores, niños o con movilidad reducida en la edificación",
  "checklist.suggest.evacuated": "La edificación ya fue evacuada o señalizada por las autoridades",
  ...
  "glossary.cimientos.def": "La base sobre la que se apoya toda la construcción, normalmente bajo el primer piso.",
  "glossary.licuefaccion.term": "Licuefacción",
  "glossary.licuefaccion.def": "Cuando el suelo lleno de agua pierde firmeza con el sismo y se comporta como lodo: puede brotar agua o arena y las estructuras se hunden o inclinan.",
  "glossary.grieta_diagonal.term": "Grieta diagonal",
  "glossary.grieta_diagonal.def": "Grieta inclinada, en forma de X o de escalera. Suele ser más seria que una grieta recta y fina porque indica esfuerzo en la estructura.",
  "glossary.golpeteo.term": "Golpeteo",
  "glossary.golpeteo.def": "Cuando dos edificios vecinos chocan entre sí durante el sismo por estar muy juntos.",
  "glossary.columna.term": "Columna",
  "glossary.columna.def": "Elemento vertical (normalmente de concreto) que sostiene el peso del edificio.",
  "glossary.viga.term": "Viga",
  "glossary.viga.def": "Elemento horizontal que conecta las columnas y sostiene los pisos y el techo.",
  "glossary.cabilla.term": "Cabilla",
  "glossary.cabilla.def": "Las barras de acero que van dentro del concreto para reforzarlo. Si quedan a la vista, el daño es serio.",
  "glossary.pandeo.term": "Pandeo",
  "glossary.pandeo.def": "Cuando una superficie que debería estar recta se ve hundida, curvada o abombada.",
  "glossary.rodapie.term": "Rodapié",
  "glossary.rodapie.def": "La moldura que une la pared con el piso. Un espacio nuevo ahí puede indicar movimiento.",
  "glossary.breaker.term": "Breaker",
  "glossary.breaker.def": "El interruptor del tablero eléctrico que corta la corriente cuando hay una falla.",
  "glossary.tomacorriente.term": "Tomacorriente",
  "glossary.tomacorriente.def": "El enchufe de la pared donde conectas los aparatos.",
  ...
  "property.age.pre1970.desc": "Construcción antigua, anterior a las normas sísmicas modernas.",
  ...
  "rule.urm.finding": "Edificación de mampostería sin refuerzo: muy vulnerable tras un sismo fuerte.",
  "rule.urm.step": "Sugerencia: por precaución, evita permanecer dentro hasta que un ingeniero colegiado o Protección Civil evalúen la edificación.",
  "rule.tilt.finding": "La edificación se ve inclinada, desplomada o hundida: posible riesgo de colapso.",
  "rule.tilt.step": "Sugerencia: no permanezcas dentro; sal y reporta a Protección Civil o a un ingeniero colegiado de inmediato.",
  "rule.liquefaction.finding": "Señales de licuefacción del suelo: el terreno perdió capacidad de soporte.",
  "rule.liquefaction.step": "Sugerencia: la estructura podría asentarse o inclinarse; considera salir y reportar a las autoridades para que la revisen.",
  "rule.pounding.finding": "Golpeteo con un edificio vecino: posible daño estructural severo.",
  "rule.pounding.step": "Sugerencia: por precaución, evita la zona de contacto entre los edificios.",
  "rule.plumbing.finding": "Daño severo de plomería o posible fuga de gas: riesgo inmediato.",
  "rule.plumbing.step": "Sugerencia: si sospechas una fuga, cierra la llave principal de gas y agua, evita encender luces o llamas y considera salir.",
  "rule.intensity.finding": "Sacudida sísmica moderada (intensidad VI o aceleración ≥0.25g) en esta ubicación.",
  "rule.intensity.step": "Sugerencia: aumenta la precaución, revisa con más cuidado y prioriza una evaluación profesional.",
  "rule.intensity_severe.finding": "Sacudida sísmica muy fuerte (intensidad VIII+ o aceleración ≥0.50g) en esta ubicación.",
  "rule.intensity_severe.step": "Sugerencia: esta zona recibió una de las sacudidas más fuertes del sismo; trata cualquier daño con máxima cautela.",
  "rule.spectral.finding": "La demanda sísmica para edificaciones de esta altura fue alta (aceleración espectral ≥0.40g).",
  "rule.spectral.step": "Sugerencia: edificios de esta altura sintieron la sacudida con especial fuerza; prioriza una revisión profesional.",
  "rule.softsoil.finding": "Suelo blando: amplifica la sacudida y aumenta el riesgo de licuefacción.",
  "rule.softsoil.step": "Sugerencia: vigila asentamientos o inclinaciones del terreno y de la edificación.",
  "rule.softsoil_severe.finding": "Suelo muy blando: fuerte amplificación de la sacudida y alto riesgo de licuefacción.",
  "rule.softsoil_severe.step": "Sugerencia: observa con cuidado el terreno y los cimientos y prioriza una evaluación profesional.",
  "rule.combo_shaking.finding": "Sacudida muy fuerte combinada con daño estructural reportado: riesgo crítico para la vida.",
  "rule.combo_shaking.step": "Sugerencia: por precaución, evita permanecer dentro hasta que un ingeniero colegiado o Protección Civil lo confirmen.",
  "rule.floors.finding": "Edificación de más de 7 pisos: requiere precaución adicional.",
  "rule.floors.step": "Sugerencia: limita el uso hasta que un ingeniero confirme la seguridad de los pisos superiores.",
  "rule.structure.finding": "El sistema estructural de esta edificación requiere precaución adicional.",
  "rule.structure.step": "Sugerencia: limita el uso y prioriza una evaluación profesional.",
  ...
  "analyze.savedHint": "Tus respuestas están guardadas. Puedes esperar aunque la señal sea lenta.",
  "analyze.waitingTitle": "Esperando conexión",
  "analyze.waitingBody": "Tus respuestas están guardadas. El análisis se ejecutará automáticamente cuando vuelva la señal.",
  "analyze.errorTitle": "No se pudo completar el análisis",
  "analyze.rateLimited": "Hay demasiadas solicitudes en este momento. Espera un momento e inténtalo de nuevo.",
  "analyze.throttled": "Has alcanzado el límite de análisis por ahora. Espera un poco antes de evaluar otra propiedad.",
  "analyze.creditsError": "El servicio de IA no está disponible temporalmente. Inténtalo más tarde.",
  "analyze.genericError": "Ocurrió un problema al analizar. Revisa tu conexión e inténtalo de nuevo.",
  ...
  "result.red.tag": "Hallazgos severos",
  ...
  "result.findingsDisclaimer": "Esto NO es un dictamen ni una certificación. Son hallazgos visuales preliminares y referenciales basados en lo que reportaste. Solo un ingeniero estructural autorizado o un organismo oficial puede determinar si la edificación es segura o habitable.",
  ...
  "building.note": "Los problemas estructurales suelen afectar a todo el edificio. Comparte tu resultado con tus vecinos y con la administración o junta de condominio para evaluar la estructura en conjunto.",
  ...
  "provisional.step.engineer": "Sugerencia: hay hallazgos en elementos estructurales; solicita pronto una inspección técnica presencial.",
  ...
  "result.seismicContextHint": "Datos del mapa de sacudida (ShakeMap) del USGS para este sismo, según la ubicación. La demanda para esta altura es la aceleración espectral en el período estimado de la edificación.",
  ...
  "result.disclaimerShort": "Hallazgos visuales preliminares, no un dictamen. La determinación de seguridad o habitabilidad corresponde a un ingeniero estructural autorizado o a un organismo oficial.",
  ...
  "nav.officialLegal": "Oficial y legal",
  ...
  "footer.tagline": "Autoevaluación de daños estructurales tras un sismo. Gratis y sin registro.",
  "footer.explore": "Explorar",
  "footer.participate": "Participar",
  "footer.resources": "Recursos",
  "footer.note": "Datos anónimos y abiertos · Proyecto comunitario de código abierto · Hecho con ❤️ para Venezuela 🇻🇪",
  "footer.evaluate": "Evaluar",
  "footer.contact": "Contacto",
  "contact.email": "contacto@evaluaya.app",
  "contact.subject": "Consulta — EvalúaYa",
  "data.title": "Sala de datos",
  "data.subtitle": "Explora los daños estructurales reportados en Venezuela. Datos anónimos y abiertos, ideales para autoridades, medios y equipos de respuesta.",
  "data.mobileNote": "Estás viendo un resumen. Abre la sala de datos en una computadora para filtros, mapa ampliado y análisis completo.",
  "data.openMap": "Ver mapa completo",
  "data.filters": "Filtros",
  "picker.mostAffected": "Zonas con más reportes",
  ...
  "dataroom.severityTitle": "Casos que priorizar",
  ...
  "dataroom.narrativeArea": "De {total} evaluaciones, el {pct}% reporta daños que requieren atención de un ingeniero. {area} es la zona con más reportes.",
  "dataroom.narrativeLow": "De {total} evaluaciones, la mayoría no reporta daños graves.",
  "data.dict.title": "¿Cómo leer estos datos?",
  "data.dict.intro": "Definiciones de los términos usados en esta página, para que todos interpreten los números de la misma forma.",
  "data.dict.evaluacion.term": "Evaluación",
  "data.dict.evaluacion.def": "Una autoevaluación enviada desde la app. No equivale a un edificio único: un mismo edificio puede tener varias evaluaciones (p. ej. distintos apartamentos).",
  "data.dict.zonas.term": "Zonas",
  "data.dict.zonas.def": "Cantidad de municipios o estados distintos con al menos una evaluación.",
  ...
  "data.dict.serious.def": "Hallazgos serios: posibles daños en elementos estructurales; conviene inspección técnica pronto.",
  ...
  "data.dict.seriousOrHigh.def": "Suma de las evaluaciones con hallazgos en nivel naranja (serios) y rojo (severos): los casos que conviene priorizar para inspección técnica. No es lo mismo que «Hallazgos severos», que cuenta solo el nivel rojo.",
  "data.dict.verified.term": "Revisado por evaluador",
  "data.dict.verified.def": "Evaluaciones revisadas por un evaluador voluntario de la comunidad, no solo por el residente.",
  "data.dict.more": "Ver metodología completa",
  "mapa.seeFullData": "Ver datos completos",
  "mapa.seeFullDataDesc": "Filtros, tendencias y análisis por zona en la sala de datos.",
  "feedback.title": "Enviar comentarios",
  "feedback.subtitle": "¿Tienes una idea, una duda o encontraste un problema? Cuéntanos y nos ayudas a mejorar EvalúaYa.",
  "feedback.messageLabel": "Tu mensaje",
  "feedback.messagePlaceholder": "Escribe aquí tu comentario, sugerencia o problema…",
  ...
  "feedback.thanksBody": "Leemos cada mensaje. Tu opinión nos ayuda a hacer EvalúaYa más útil para todos.",
  "feedback.backHome": "Volver al inicio",
  "feedback.privacy": "No registramos datos personales. Tu correo es opcional y solo se usa para responderte.",
  "feedback.promptTitle": "¿Cómo te resultó?",
  "feedback.promptBody": "Comparte tu opinión para mejorar la app.",
  "help.title": "Ayuda",
  "help.subtitle": "Aprende a usar EvalúaYa y resuelve las dudas más comunes.",
  "help.quickStartTitle": "Cómo hacer una evaluación",
  "help.step1Title": "1. Datos de la propiedad",
  "help.step1Desc": "Indica la dirección, el tipo de edificación, los pisos y la antigüedad.",
  "help.step2Title": "2. Observa y reporta",
  "help.step2Desc": "Responde preguntas simples (Sí / No / No estoy seguro) área por área y, si puedes, sube una foto.",
  "help.step3Title": "3. Análisis con IA",
  "help.step3Desc": "Recibes hallazgos visuales organizados (Leves / Moderados / Serios / Severos) con una explicación clara y sugerencias. No es un dictamen.",
  "help.step4Title": "4. Guarda y comparte",
  "help.step4Desc": "Descarga un PDF, compártelo por WhatsApp o guárdalo para consultarlo después.",
  ...
  "help.faq.signupA": "No. Puedes evaluar tu vivienda sin crear una cuenta. Si quieres guardar tus reportes para verlos más adelante, puedes crear una cuenta opcional con tu correo.",
  "help.faq.behalfQ": "¿Puedo evaluar por otra persona?",
  "help.faq.behalfA": "Sí. Puedes completar una evaluación en nombre de un vecino o familiar (por ejemplo, alguien que está en un refugio) con lo que puedas observar o con fotos que te envíen.",
  "help.faq.offlineQ": "¿Funciona sin internet o con poca señal?",
  "help.faq.offlineA": "Sí. Puedes responder el cuestionario con poca señal; tu avance se guarda en el dispositivo y el análisis se envía cuando recuperes conexión.",
  "help.faq.resultsQ": "¿Qué significan los colores del resultado?",
  "help.faq.resultsA": "Describen hallazgos visuales, no un veredicto de seguridad. Verde: hallazgos leves. Amarillo: hallazgos moderados. Naranja: hallazgos serios. Rojo: hallazgos severos. En todos los casos, la determinación de seguridad o habitabilidad corresponde a un ingeniero estructural autorizado o a un organismo oficial.",
  "help.faq.engineerQ": "¿Puedo pedir que un evaluador revise mi caso?",
  "help.faq.engineerA": "Sí. Al terminar tu evaluación puedes enviar una solicitud gratuita. Un evaluador voluntario de la comunidad recibe el aviso y puede contactarte por WhatsApp para orientarte, sin costo. No emite dictámenes periciales.",
  "help.faq.privacyQ": "¿Mis datos son privados?",
  "help.faq.privacyA": "Sí. La evaluación es anónima. No pedimos tu nombre ni datos personales para usar la app.",
  "help.faq.saveQ": "¿Cómo guardo y vuelvo a ver mis reportes?",
  "help.faq.saveA": "En la pantalla de resultados puedes crear una cuenta con tu correo (enlace mágico, sin contraseña) para acceder a tus reportes desde “Mis reportes” cuando quieras.",
  "help.faq.photosQ": "¿Las fotos son obligatorias?",
  "help.faq.photosA": "No. Las fotos son opcionales, pero ayudan a que el análisis sea más preciso.",
  "help.faq.newDamageQ": "¿Qué daños debo reportar?",
  "help.faq.newDamageA": "Reporta solo el daño nuevo causado por el sismo reciente, no las grietas o fallas que ya existían antes. Así el resultado refleja mejor el riesgo actual.",
  "help.faq.officialQ": "¿Esto reemplaza una inspección oficial?",
  "help.faq.officialA": "No. EvalúaYa ofrece una orientación preliminar y no sustituye la inspección de un ingeniero estructural autorizado ni de Protección Civil.",
  "help.moreTitle": "¿Necesitas más ayuda?",
  "help.moreBody": "Escríbenos si tienes una duda que no aparece aquí, o conoce cómo calculamos los resultados.",
  ...
  "home.seoTagline": "Sabe en 2 minutos si tu vivienda es segura para entrar tras el sismo.",
  ...
  "home.exploreDesc": "Consulta los reportes y evalúa tu vivienda según tu estado.",
  ...
  "zona.intro": "Mira cómo está {estado} según los reportes anónimos de la comunidad y evalúa tu vivienda gratis, sin registro y en pocos minutos.",
  ...
  "zona.noData": "Aún no hay reportes en {estado}. Sé la primera persona en evaluar tu vivienda y ayudar a tu comunidad.",
  "zona.aboutTitle": "¿Cómo se calculan estos datos?",
  "zona.aboutBody": "Las cifras son conteos anónimos de autoevaluaciones realizadas en la app. Nunca mostramos direcciones, fotos ni datos personales.",
  ...
  "zona.municipiosWithReportsHint": "Toca un municipio para ver sus reportes en detalle.",
  "municipio.eyebrow": "Reporte por municipio",
  "municipio.h1Prefix": "Daños estructurales en",
  "municipio.intro": "Reportes anónimos de la comunidad en {municipio}, {estado}. Evalúa tu vivienda gratis, sin registro y en pocos minutos.",
  ...
  "municipio.notEnough": "Aún no hay suficientes reportes en {municipio} para mostrar un resumen. Sé parte de los primeros en evaluar tu vivienda y ayudar a tu comunidad.",
  ...
  "property.locationHint": "Solo usamos la zona (estado/municipio) para el mapa comunitario. Nunca mostramos tu dirección exacta.",
  ...
  "map.subtitle": "Reportes anónimos y agregados por zona. Nunca se muestran direcciones ni fotos.",
  ...
  "map.distribution": "Distribución por nivel",
  ...
  "map.dataNote": "Datos abiertos y anónimos para autoridades, ONG y prensa.",
  "map.cardHeadline": "Daños estructurales reportados",
  "map.cardCta": "Evalúa tu vivienda gratis en EvalúaYa",
  "map.storyIntro": "Desplázate para ver la historia detrás de los datos: qué tan serios son los daños, cómo evolucionan y por qué.",
  "map.severityTitle": "Qué tan serio es",
  "map.severityNeedAttention": "necesitan atención urgente",
  "map.severityCaption": "Proporción de evaluaciones en nivel naranja o rojo: daños moderados a graves que requieren un ingeniero.",
  "map.severityTopArea": "Zona con más reportes",
  "map.severityNone": "Por ahora, la mayoría de las evaluaciones no muestran daños serios.",
  "map.trendTitle": "Reportes en el tiempo",
  "map.trendSubtitle": "Evaluaciones por día (últimos 90 días), divididas por nivel de riesgo.",
  ...
  "apiUsage.subtitle": "Uso de la API pública de datos. Solicitudes que llegan al servidor — los datos servidos desde caché no se cuentan, así que es un mínimo.",
  ...
  "apiUsage.emptyHint": "Cuando alguien use la API de datos abiertos, el uso aparecerá aquí.",
  "apiUsage.calls": "llamadas",
  "apiUsage.docsCta": "Ver la API",
  "photos.title": "Documentación fotográfica",
  "photos.subtitle": "Cuántas fotos respaldan los reportes. Solo conteos — nunca se muestran las fotos.",
  ...
  "photos.coverageSubtitle": "Qué elementos estructurales están mejor documentados con fotos.",
  ...
  "map.whySubtitle": "Los factores que más se repiten en las evaluaciones a nivel nacional: daños marcados, antigüedad y tipo de construcción, intensidad sísmica y reglas de seguridad activadas.",
  "map.exportTitle": "Exporta y comparte",
  "map.exportSubtitle": "Lleva estos datos a un ingeniero, autoridad o medio de comunicación.",
  "result.shareWhatsapp": "Compartir por WhatsApp",
  "result.whatsappMessage": "Evalué los daños estructurales de mi edificio con EvalúaYa. Evalúa el tuyo también, es gratis:",
  "result.inviteTitle": "Ayuda a tu comunidad",
  "result.inviteBody": "Comparte EvalúaYa con tus vecinos. Mientras más personas evalúan, mejor entendemos los daños de cada zona.",
  ...
  "result.proBadgeDesc": "Este reporte fue revisado por un evaluador voluntario de la comunidad; no es un dictamen pericial ni una certificación.",
  "result.residentBadge": "Autoevaluación de residente",
  "result.shareOwnerTitle": "¿Es para otra persona?",
  "result.shareOwnerBody": "Comparte estos hallazgos con el dueño o residente para que busque una inspección técnica.",
  "share.title": "Ayuda a difundir EvalúaYa",
  "share.body": "Compártelo con tu familia y vecinos. Mientras más personas evalúan sus viviendas, mejor entendemos los daños de cada zona. ❤️",
  "share.whatsapp": "Compartir por WhatsApp",
  "share.copy": "Copiar enlace",
  "share.copied": "¡Enlace copiado!",
  "share.message": "Evalúa los daños de tu vivienda tras el sismo con EvalúaYa — gratis, sin registro y funciona con poca señal: 🇻🇪",
  ...
  "inst.body": "Si representas a una alcaldía, Protección Civil, una ONG o el sector privado y necesitas acceso a estos datos, déjanos tus datos.",
  ...
  "methodology.subtitle": "Cómo calculamos el resultado y de dónde viene nuestra credibilidad.",
  "methodology.maintainedBy": "Esta página la mantiene el equipo de EvalúaYa para explicar cómo funciona la herramienta. Puede actualizarse a medida que mejoramos el método.",
  "methodology.intro": "EvalúaYa combina reglas de seguridad comprobadas con una capa de apoyo de inteligencia artificial que resume tus respuestas y fotos para darte una orientación rápida en cuatro niveles: 🟢 verde, 🟡 amarillo, 🟠 naranja o 🔴 rojo. Son hallazgos visuales preliminares para ayudarte a decidir el siguiente paso; no son un dictamen ni reemplazan a un ingeniero. Aquí explicamos cada paso para que puedas validarlo antes de usarlo o compartirlo.",
  "methodology.layersTitle": "Dos capas de análisis",
  "methodology.layersIntro": "Cada evaluación pasa por dos capas. El resultado final siempre toma el nivel más severo de las dos.",
  "methodology.layerA.title": "Capa 1 · Reglas de seguridad",
  "methodology.layerA.body": "Reglas deterministas basadas en criterios profesionales de inspección rápida. Se aplican siempre y pueden anular a la IA cuando hay señales claras de peligro para la vida.",
  "methodology.red.title": "Obligan a ROJO (no entrar)",
  "methodology.red.urm": "Mampostería no reforzada: paredes de bloque o ladrillo sin estructura de concreto.",
  "methodology.red.liquefaction": "Señales de licuación del suelo: hundimientos, grietas con barro o agua.",
  "methodology.red.pounding": "Golpeteo entre edificios vecinos durante el sismo.",
  "methodology.red.plumbing": "Daño grave en tuberías o gas.",
  "methodology.red.combo": "Sacudida muy fuerte (MMI VIII+ o PGA ≥0.50g) junto con daño estructural reportado.",
  "methodology.yellow.title": "Elevan a AMARILLO (precaución)",
  "methodology.yellow.intensity": "Sacudida moderada en tu ubicación: intensidad MMI VI+ o aceleración pico (PGA) ≥0.25g.",
  "methodology.yellow.soil": "Suelo blando (vs30 bajo), que amplifica la sacudida y aumenta el riesgo de licuefacción.",
  "methodology.yellow.floors": "Edificios de más de 7 pisos.",
  "methodology.yellow.structure": "Sistemas estructurales más vulnerables: pórticos de concreto, paredes de relleno, prefabricado o mampostería reforzada baja.",
  "methodology.orange.title": "Elevan a NARANJA (necesitas un ingeniero pronto)",
  "methodology.orange.urm": "Mampostería no reforzada, aun sin daño visible ni sacudida fuerte: por su fragilidad necesita revisión profesional pronto.",
  "methodology.orange.severe": "Sacudida muy fuerte en tu ubicación (MMI VIII+ o PGA ≥0.50g), incluso sin daño visible.",
  "methodology.orange.spectral": "Demanda sísmica alta para la altura del edificio: aceleración espectral ≥0.40g en su período estimado.",
  "methodology.orange.soil": "Suelo muy blando (vs30 muy bajo), que amplifica fuertemente la sacudida y eleva el riesgo de licuefacción.",
  "reclassify.orange.note": " Actualizado a Naranja con la nueva escala de 4 niveles: los elementos estructurales reportados requieren la inspección de un ingeniero.",
  "reclassify.updated": "Resultado actualizado de «{from}» a «{to}» con la nueva escala de 4 niveles (🟢🟡🟠🔴), que distingue mejor el daño moderado del serio.",
  "methodology.layerB.title": "Capa 2 · Apoyo con IA",
  "methodology.layerB.body": "Tus respuestas y las fotos que subes (fachada y daños) se envían a un modelo de visión por IA que actúa como un apoyo de triaje rápido tipo ATC-20: resume los hallazgos visuales y sugiere próximos pasos en lenguaje sencillo. Es una capa de apoyo, no un veredicto: la IA es conservadora y, ante la duda sobre la seguridad, no elige verde. No reemplaza la inspección de un ingeniero.",
  "methodology.checklistTitle": "Qué observas y reportas",
  "methodology.checklistBody": "El proceso son 2 pasos. En «Observa y reporta» respondes 4 preguntas principales (paredes, columnas y vigas, puertas y ventanas, inclinación del edificio) y marcas señales graves si las hubo (licuación del suelo, golpeteo entre edificios, daño en tuberías o gas, techo y escaleras). Las fotos son obligatorias: la fachada (hasta 5) y los daños (entre 5 y 10). También puedes agregar notas y datos opcionales de servicios (pisos, plomería, electricidad, objetos colgantes) que ayudan al ingeniero.",
  "methodology.seismicTitle": "Contexto sísmico",
  "methodology.seismicBody": "Si compartes tu ubicación, leemos varias capas de la malla oficial de ShakeMap del USGS para el sismo activo, interpoladas a tu punto exacto: la intensidad (MMI), la aceleración pico del suelo (PGA), la velocidad pico (PGV), la aceleración espectral en distintos períodos y la rigidez del suelo (vs30). Estimamos el período natural del edificio según su altura (T ≈ 0.1 × pisos) y lo comparamos con la aceleración espectral de ese período, para saber cuánta sacudida sintió realmente una edificación de esa altura. El suelo blando (vs30 bajo) se marca porque amplifica la sacudida y favorece la licuefacción. Estos valores elevan el nivel de precaución de forma graduada y se incluyen en el contexto que recibe la IA.",
  "methodology.sourcesTitle": "Fuentes y credibilidad",
  "methodology.sourcesIntro": "Nuestra lógica se modela sobre marcos públicos reconocidos:",
  "methodology.source.atc20": "ATC-20 — Evaluación rápida de seguridad de edificios tras un sismo (el concepto de etiqueta verde/amarillo/rojo).",
  "methodology.source.usgs": "USGS ShakeMap y la escala de Intensidad de Mercalli Modificada (MMI) para la intensidad de sacudida.",
  "methodology.source.urm": "Consenso de ingeniería sísmica sobre la vulnerabilidad de la mampostería no reforzada y los pisos blandos.",
  "methodology.source.ai": "Modelo de visión por IA a través de Lovable AI Gateway, usado como apoyo para el triaje preliminar. No es un certificador ni emite un dictamen.",
  "methodology.limitsTitle": "Límites y responsabilidad compartida",
  "methodology.limit.notCert": "Esto NO es una certificación ni un dictamen, y no reemplaza a un ingeniero colegiado ni a Protección Civil. Son hallazgos visuales preliminares para orientarte.",
  "methodology.limit.surface": "Solo evalúa lo visible que reportas. No inspecciona elementos ocultos, fundaciones enterradas ni el interior de los muros.",
  "methodology.limit.depends": "La calidad del resultado depende de tus respuestas y de la nitidez de las fotos.",
  "methodology.limit.privacy": "No se requiere registro. Solo usamos la zona (estado/municipio) para el mapa comunitario; nunca mostramos tu dirección exacta ni tus fotos.",
  "methodology.engineersTitle": "Para ingenieros",
  "methodology.engineersBody": "¿Quieres validar el algoritmo a nivel de código? Descarga la especificación técnica: incluye las reglas deterministas, la interpolación de intensidad sísmica (USGS ShakeMap), el prompt exacto del modelo de IA y la lógica de combinación.",
  ...
  "methodology.disclaimer": "En una emergencia, llama a Protección Civil o a los servicios de emergencia.",
  "nav.volunteers": "Ingenieros voluntarios",
  "nav.volunteersShort": "Voluntarios",
  "connect.title": "Pide ayuda de un evaluador voluntario",
  "connect.subtitleRed": "Tus hallazgos son severos. Envía tu caso y lo compartiremos con la red de evaluadores voluntarios de la comunidad. Es un servicio comunitario gratuito.",
  "connect.subtitleOrange": "Tus hallazgos son serios. Envía tu caso y lo compartiremos con la red de evaluadores voluntarios de la comunidad. Es un servicio comunitario gratuito.",
  "connect.subtitleYellow": "Envía tu caso y lo compartiremos con la red de evaluadores voluntarios de la comunidad, que puede ayudarte a interpretar estos hallazgos. Es un servicio comunitario gratuito.",
  ...
  "connect.requestBody": "Deja tus datos y compartiremos tu caso con evaluadores voluntarios registrados de tu zona. Si un voluntario está disponible, te escribirá por WhatsApp. Es un esfuerzo comunitario: no podemos garantizar una respuesta ni un tiempo específico.",
  "connect.requestCta": "Enviar solicitud",
  "connect.requestSending": "Enviando…",
  "connect.requestDone": "¡Recibimos tu solicitud! Te avisaremos por correo cuando un voluntario tome tu caso. Guarda el enlace de seguimiento que te enviamos.",
  "connect.requestError": "No se pudo enviar. Intenta de nuevo.",
  "connect.trackCta": "Ver el estado de mi caso",
  "connect.yourName": "Tu nombre y apellido",
  "connect.namePlaceholder": "Ej.: María Rodríguez",
  "connect.yourEmail": "Tu correo electrónico",
  "connect.emailPlaceholder": "Ej.: maria@correo.com",
  "connect.emailHint": "Te enviaremos ahí las actualizaciones de tu caso y un enlace para seguir su estado.",
  ...
  "connect.privacy": "Tus datos solo se comparten con evaluadores voluntarios de la comunidad registrados. No se publican.",
  "connect.areEngineer": "¿Eres ingeniero? Súmate como voluntario",
  "track.title": "Seguimiento de tu solicitud",
  "track.subtitle": "Aquí puedes ver el estado de tu caso. Guarda este enlace para volver cuando quieras.",
  "track.loading": "Cargando el estado…",
  "track.notFound": "No encontramos esta solicitud. Verifica el enlace que recibiste por correo.",
  "track.location": "Ubicación",
  "track.risk": "Nivel de hallazgos",
  "track.stage.received": "Solicitud recibida",
  "track.stage.received.desc": "Compartimos tu caso con la red de evaluadores voluntarios de tu zona.",
  "track.stage.claimed": "Un voluntario tomó tu caso",
  "track.stage.claimed.desc": "Un evaluador voluntario se hará cargo y podría escribirte por WhatsApp.",
  "track.stage.contacted": "El voluntario te contactó",
  "track.stage.contacted.desc": "El evaluador se puso en contacto contigo para coordinar.",
  "track.stage.visited": "Revisión realizada",
  "track.stage.visited.desc": "El evaluador revisó la situación reportada.",
  "track.stage.resolved": "Caso cerrado",
  "track.stage.resolved.desc": "El evaluador marcó tu caso como atendido.",
  "track.waiting": "Aún no ha sido tomado por un voluntario. Es un esfuerzo comunitario, así que el tiempo de respuesta puede variar.",
  "track.confirmTitle": "¿Se resolvió tu caso?",
  "track.confirmBody": "Cuéntanos si un voluntario ya te atendió. Esto nos ayuda a cerrar el caso o a reactivarlo si aún necesitas ayuda.",
  "track.confirmYes": "Sí, ya me atendieron",
  "track.confirmNo": "No, sigo esperando",
  "track.confirmedResolved": "Gracias por confirmar. Marcamos tu caso como resuelto.",
  ...
  "vol.subtitle": "Iniciativa comunitaria. Cuando una familia pide ayuda tras su autoevaluación, compartimos su caso con la red de evaluadores voluntarios. Si hay un voluntario disponible en su zona, la orienta por videollamada y, si hace falta, con una visita presencial. Es un servicio gratuito y depende de la disponibilidad de la comunidad.",
  ...
  "vol.how3": "Recibes solicitudes de familias que pidieron ayuda tras su autoevaluación. Las orientas por videollamada o WhatsApp y, si es posible, con una visita presencial.",
  ...
  "vol.emailHint": "Lo necesitamos para enviarte tu enlace de acceso cuando te validemos.",
  "vol.verifyTitle": "Registro profesional",
  "vol.verifyHint": "Para conocer mejor a cada voluntario(a), agrega tu número de colegiatura (CIV) y un documento que respalde tu profesión. Acelera tu aprobación.",
  ...
  "vol.credentialHint": "PDF o imagen (carnet del CIV, título, constancia laboral). Máx. 6 MB. Solo lo ve nuestro equipo de validación.",
  ...
  "vol.successBody": "Revisaremos tu solicitud y te enviaremos un enlace privado para ver las solicitudes de tu zona.",
  ...
  "vol.verifiedSubtitle": "Profesionales y organizaciones registradas que se sumaron a la red comunitaria.",
  "vol.verifiedEmptyTitle": "Sé el primero",
  "vol.verifiedEmptyBody": "Aún no hay evaluadores registrados. Súmate hoy y aparece aquí cuando validemos tu solicitud.",
  ...
  "vol.residentNoteBody": "Completa tu evaluación y, al final, podrás solicitar una conexión con un evaluador voluntario de la comunidad.",
  ...
  "panel.proBody": "Acompaña al residente con una evaluación de apoyo. Responderás las mismas preguntas y el reporte quedará marcado como revisado por un evaluador voluntario en el mapa. No es un dictamen ni un certificado de habitabilidad.",
  "panel.startPro": "Iniciar evaluación de apoyo",
  "panel.invalid": "Enlace no válido o no aprobado",
  "panel.invalidBody": "Este enlace no corresponde a un evaluador voluntario aprobado. Si crees que es un error, contáctanos.",
  ...
  "panel.waResident": "Hola, soy evaluador voluntario de la comunidad en EvalúaYa. Vi tu solicitud de orientación tras tu evaluación. ¿En qué puedo ayudarte?",
  ...
  "admin.rotateConfirm": "Esto invalidará el enlace anterior del voluntario y generará uno nuevo. ¿Continuar?",
  ...
  "panel.reviewBody": "Deja tus observaciones profesionales tras orientar al residente. Esto marca el reporte como revisado por un evaluador voluntario; no es un dictamen ni un certificado de habitabilidad.",
  ...
  "panel.reviewDescargo": "Declaro que mis observaciones son orientativas y voluntarias, que no constituyen un dictamen oficial ni un certificado de habitabilidad, y que la decisión sobre la seguridad corresponde a una inspección formal de un ingeniero estructural colegiado, FUNVISIS o Protección Civil.",
  ...
  "panel.remitBody": "Recuérdale al residente que puede mostrar este reporte y tus observaciones a las autoridades para solicitar la evaluación oficial.",
  ...
  "dash.buildingsHint": "Estructuras con 2 o más evaluaciones. Útil para detectar un mismo edificio que genera varias alertas.",
  ...
  "dash.matchingProgressHint": "Lo que el ingeniero(a) reporta tras reclamar una solicitud.",
  ...
  "dash.qualityHint": "Completitud de datos y reportes que necesitan atención.",
  ...
  "dash.worklistHint": "Filtra y actúa sobre reportes de baja calidad o de alto riesgo sin verificar.",
  ...
  "dash.verificationHint": "Confirma evaluaciones con ingenieros y cierra el círculo en reportes de alto riesgo.",
  ...
  "dash.vUnverifiedEmpty": "Todos los reportes de alto riesgo están verificados.",
  "dash.actionError": "No se pudo completar la acción",
  "vadmin.triage": "Triaje de solicitudes",
  "vadmin.triageHint": "Solicitudes en riesgo de estancarse. Actúa para llevarlas a término.",
  ...
  "seg.hint": "Casos urgentes primero (🔴/🟠). Asigna un(a) ingeniero(a) o empuja para llevarlos a término.",
  ...
  "account.saveBody": "¿Quieres volver a ver este reporte más adelante o desde otro teléfono? Recibe un enlace por correo para guardarlo. Sin contraseña.",
  "account.saveHint": "Solo usamos tu correo para enviarte el enlace de acceso. Sin contraseña ni spam. No es obligatorio.",
  ...
  "account.checkEmailBody": "Te enviamos un enlace de acceso. Ábrelo desde este teléfono o cualquier otro para ver tus reportes guardados.",
  "account.savedTitle": "Tus reportes están guardados",
  "account.savedBody": "Tu sesión está activa. Puedes ver tus reportes en cualquier momento.",
  "account.viewMyReports": "Mis reportes",
  "account.myReportsTitle": "Mis reportes",
  "account.signInBody": "Inicia sesión con tu correo para ver los reportes que has guardado.",
  "account.loading": "Cargando tus reportes…",
  "account.emptyReports": "Aún no tienes reportes guardados en esta cuenta. Cuando guardes un reporte, aparecerá aquí.",
  "account.signOut": "Cerrar sesión",
  "account.claimToast": "Reporte guardado en tu cuenta.",
  "dash.accounts": "Cuentas guardadas",
  "dash.accountsHint": "Personas que guardaron sus reportes con su correo (cuenta opcional, sin contraseña).",
  ...
  "privacy.subtitle": "Cómo EvalúaYa recoge, usa y protege tus datos. Escrito en lenguaje claro.",
  "privacy.updated": "Última actualización: junio de 2026",
  "privacy.intro": "EvalúaYa es una herramienta gratuita para autoevaluar daños estructurales tras un sismo. Puedes hacer una evaluación sin registrarte. Esta página explica qué información recogemos y qué hacemos con ella.",
  "privacy.responsible.title": "Quién es responsable",
  "privacy.responsible.body": "El responsable de esta aplicación es EvalúaYa.app. Para cualquier consulta sobre privacidad puedes escribir a contacto@evaluaya.app.",
  "privacy.collect.title": "Qué datos recogemos",
  "privacy.collect.intro": "Según cómo uses la app, podemos recoger:",
  "privacy.collect.b1": "Tus respuestas de la inspección y los datos de la propiedad (tipo de edificación, pisos, antigüedad, nombre del edificio).",
  "privacy.collect.b2": "Ubicación aproximada que ingresas: estado, municipio y el texto de dirección o sector.",
  "privacy.collect.b3": "Fotos que decidas subir (son opcionales). Se guardan en almacenamiento privado.",
  "privacy.collect.b4": "Tu correo electrónico solo si creas una cuenta para guardar reportes, te registras como voluntario, envías comentarios o eres una institución interesada.",
  "privacy.collect.b5": "Datos técnicos básicos para evitar abuso (por ejemplo, una dirección IP usada de forma temporal para límites de uso).",
  "privacy.use.title": "Cómo usamos los datos",
  "privacy.use.intro": "Usamos la información para:",
  "privacy.use.b1": "Generar tu resultado mediante un análisis estructural automatizado (IA) y reglas de seguridad.",
  "privacy.use.b2": "Crear el reporte que puedes guardar, descargar en PDF y compartir.",
  "privacy.use.b3": "Producir estadísticas anónimas y agregadas para el mapa y la sala de datos.",
  "privacy.use.b4": "Conectar a los residentes que lo solicitan con un ingeniero voluntario registrado.",
  "privacy.share.title": "Qué compartimos",
  "privacy.share.body": "Las fotos se mantienen en almacenamiento privado y solo se acceden mediante enlaces firmados temporales. Las superficies públicas (mapa, sala de datos, API abierta) muestran únicamente conteos anónimos y agregados: nunca direcciones, fotos ni identificadores de reportes. No vendemos tus datos.",
  "privacy.retention.title": "Conservación",
  "privacy.retention.body": "Conservamos los reportes para mantener el historial del edificio y las estadísticas agregadas. Puedes pedir acceso o eliminación de tus datos escribiendo al correo de contacto.",
  "privacy.processors.title": "Proveedores",
  "privacy.processors.body": "Nos apoyamos en proveedores de infraestructura para el alojamiento, la base de datos, el análisis con IA y el envío de correos. Solo procesan datos para prestar estos servicios en nuestro nombre.",
  "privacy.cookies.title": "Cookies y almacenamiento del dispositivo",
  "privacy.cookies.body": "Guardamos información en tu dispositivo para que la app funcione sin conexión (borradores y cola de envío) y para recordar tu idioma. Usamos analítica básica para entender el uso de la app.",
  "privacy.rights.title": "Tus derechos",
  "privacy.rights.body": "Puedes solicitar acceso, corrección o eliminación de tus datos personales, o retirar tu correo, en cualquier momento escribiendo a contacto@evaluaya.app.",
  "privacy.contact.title": "Contacto",
  "privacy.contact.body": "¿Preguntas sobre privacidad? Escríbenos a contacto@evaluaya.app.",
  "privacy.disclaimer": "EvalúaYa ofrece orientación preliminar y no sustituye la inspección de un ingeniero estructural autorizado ni de Protección Civil.",
  "data.api.title": "Datos abiertos / API",
  "data.api.body": "Publicamos los datos anónimos y agregados como una API abierta para autoridades, medios, investigadores y agentes de IA. Solo conteos: nunca direcciones, fotos ni identificadores.",
  ...
  "official.dir.subtitle": "Números oficiales para solicitar la evaluación oficial de tu edificio y para emergencias. Toca para llamar.",
  ...
  "official.dir.note": "EvalúaYa publica estos números oficiales para marcado directo. No gestiona ni se responsabiliza por estas comunicaciones. Al ser información de contingencia, puede cambiar: confírmala antes de acudir.",
  "official.pc_caracas.name": "Protección Civil — Gobierno de Caracas",
  "official.pc_caracas.desc": "Contacto clave para coordinar la evaluación de infraestructuras residenciales y públicas.",
  ...
  "official.pcivil.desc": "0800-PCIVIL1 · contingencias generales y rescates a gran escala.",
  "official.bomberos.name": "Bomberos de Caracas",
  "official.bomberos.desc": "Incendios, primeros auxilios y confinamientos en estructuras caídas.",
  "official.cruzroja.name": "Cruz Roja",
  "official.cruzroja.desc": "Asistencia prehospitalaria, apoyo humanitario y localización de personas.",
  "official.funvisis.name": "FUNVISIS",
  "official.funvisis.desc": "0-800-TEMBLOR · servicio gratuito 24 h. CEDI lun–vie 8:00–12:00 y 1:00–4:00.",
  "official.civ.name": "Colegio de Ingenieros de Venezuela (CIV)",
  "official.civ.desc": "Orienta sobre especialistas certificados. Sede: Av. Principal de Quebrada Honda, Los Caobos, Caracas.",
  "sos.title": "¿Peligro inminente?",
  "sos.body": "Si hay riesgo para la vida —colapso, personas atrapadas, olor a gas— llama de inmediato.",
  "sos.call911": "Llamar VEN 9-1-1",
  "sos.callPcivil": "Protección Civil 0800",
  "transparency.title": "Esto no es la inspección oficial",
  "transparency.body": "EvalúaYa es solo una verificación visual rápida (Fase 0). Para la evaluación oficial de tu edificio, contacta a Protección Civil del Gobierno de Caracas: (0212) 575-1823. En emergencia: VEN 9-1-1 o 0800-PCIVIL1. La etiqueta oficial solo la coloca personal certificado por la autoridad.",
  "transparency.limits": "Incluso la inspección oficial no garantiza la seguridad ante eventos futuros: pueden existir situaciones fuera de su alcance y las condiciones de estabilidad pueden cambiar.",
  "transparency.cta": "Ver contactos oficiales",
  "transparency.processCta": "Conoce el proceso oficial",
  "transparency.remit": "Puedes mostrar este reporte (y su PDF) a las autoridades al solicitar la evaluación oficial. Si un ingeniero voluntario lo revisa, también puedes compartir sus observaciones: ayudan pero no reemplazan la inspección oficial.",
  "pdf.officialTitle": "Contactos oficiales",
  "pdf.officialIntro": "Esto es solo una verificación visual rápida, no la inspección oficial. Solicita la evaluación oficial de tu edificio:",
...
const en: Dict = {
  ...
  "home.heroSubtitle": "A step-by-step guide to check structural damage after an earthquake. No sign-up. Works on low signal.",
  ...
  "methodology.encyclopediaTitle": "Explore the Encyclopedia",
  "methodology.encyclopediaBody": "Clear guides on earthquakes in Venezuela, what to do after a tremor and how to check your home.",
  "methodology.encyclopediaCta": "Go to the Encyclopedia",
  ...
  "engineers.tagline": "After your assessment, you can request help from a volunteer engineer, at no cost.",
  "engineers.homeBody": "When a family asks after their self-assessment, we connect them with a volunteer civil engineer. Join us to reach more communities.",
  "engineers.recruit": "We recruit",
  "engineers.recruitDesc": "We bring in volunteer engineers and organizations across the country.",
  "engineers.validate": "We validate",
  "engineers.validateDesc": "We review their experience before adding them as registered volunteers.",
  "engineers.connect": "We connect",
  "engineers.connectDesc": "When a family asks after their self-assessment, we link them with a registered volunteer engineer who guides them over a video call — and in person if needed. At no cost.",
  "engineers.learnMore": "Become a volunteer engineer",
  "engineers.mapNote": "After an assessment, residents can request support from a registered volunteer engineer.",
  "engineers.footerDesc": "We recruit, validate and connect engineers.",
  "engineers.methodologyTitle": "Volunteer engineer network",
  "engineers.methodologyBody": "Self-assessment is the first step. We also recruit and register volunteer engineers and organizations, and connect residents who request it with a registered volunteer professional to confirm or adjust the result.",
  "disclaimer.title": "Important notice",
  "disclaimer.body": "This tool gives preliminary guidance and is not a substitute for inspection by a licensed structural engineer or Civil Protection. If there is imminent danger, evacuate and call emergency services.",
  ...
  "legal.intro": "EvalúaYa is a non-profit, community-built initiative. Before using the tool or connecting with a volunteer engineer, please read how it works and what its limits are.",
  "legal.s1.title": "It does not replace an official inspection",
  "legal.s1.body": "Neither this tool nor contact with a volunteer engineer replaces a formal inspection by a licensed structural engineer, FUNVISIS or Civil Protection. The result is informational only and is not a certificate of habitability or an official ruling.",
  "legal.s2.title": "It is preliminary technical guidance",
  "legal.s2.body": "Any assessment — automated or carried out by a volunteer engineer — is preliminary guidance based on what is reported and visible to the naked eye. It does not analyze hidden elements, buried foundations or the inside of walls, and does not replace a detailed structural study.",
  "legal.s3.title": "Volunteer engineers",
  "legal.s3.body": "The engineers and organizations that take part do so voluntarily and free of charge. EvalúaYa does not pay them and has no employment or commercial relationship with them; they act in a personal capacity. We register the information they provide, but we do not verify or guarantee their credentials, their services or the outcome of their recommendations.",
  "legal.s4.title": "Limitation of liability",
  "legal.s4.body": "EvalúaYa, its collaborators and the volunteer engineers are not liable for the recommendations given, the decisions made based on them, or any damages arising from use of the application. The final decision and the responsibility over the building rest with its owner or occupant and the competent authorities.",
  "legal.s5.title": "Emergencies",
  "legal.s5.body": "If there is imminent danger, do not wait for an assessment: evacuate immediately and call Civil Protection or emergency services.",
  "legal.contact.title": "Contact",
  "legal.contact.body": "Questions about this notice? Write to us at contacto@evaluaya.app. See also our Privacy Policy.",
  "legal.short": "Preliminary volunteer guidance; it does not replace an official inspection. Engineers are unpaid volunteers and EvalúaYa is not liable for their recommendations.",
  "legal.readMore": "Read the full legal notice",
  "legal.ack": "I understand this is preliminary guidance from unpaid volunteers and does not replace an official inspection.",
  "gate.title": "Before you continue",
  "gate.subtitle": "EvalúaYa is a private, community-built, non-profit initiative. Read and accept to use the tool.",
  "gate.c1.title": "Not an official body",
  "gate.c1.body": "An independent, community-built initiative with no affiliation to FUNVISIS, Civil Protection, the Fire Department or any government body.",
  "gate.c2.title": "It does not issue technical rulings",
  "gate.c2.body": "The tool only processes preliminary, reference-only visual findings. It does not issue certificates of habitability, structural rulings or entry authorizations.",
  "gate.c3.title": "Force majeure and environmental factors",
  "gate.c3.body": "We are not liable for damage arising from aftershocks, environmental factors or later events. Use of the information is at the user's own risk.",
  "gate.accept": "I have read and accept the legal notice and disclaimer of liability.",
  ...
  "property.buildingNameHint": "Optional. Helps group reports from the same building on the map. Don't include your apartment number.",
  ...
  "property.behalfHint": "Can't safely enter the building? A relative or neighbor can run this inspection for you and share the result.",
  ...
  "property.struct.URM.desc": "Block or brick walls with no concrete columns or beams supporting them.",
  ...
  "property.struct.CIW.desc": "Concrete columns and beams with block walls filling between them.",
  ...
  "property.struct.RML.desc": "Block/brick walls with steel reinforcement, few floors.",
  ...
  "checklist.optionalNote": "The more you answer, the more accurate the analysis. Optional questions can be skipped.",
  ...
  "item.liquefaction.q": "Are there signs of soil liquefaction? (water and sand bubbling up, pooling water where there was none, large fissures on sloping ground, pipes or tanks pushed to the surface, or sunken/tilted structures)",
  "item.exterior_walls.area": "Exterior walls",
  "item.exterior_walls.q": "Are there diagonal cracks or separation from neighboring buildings?",
  "item.pounding.area": "Building pounding",
  "item.pounding.q": "Did the building collide or pound against an adjacent building during the quake?",
  "item.interior_walls.area": "Interior walls",
  "item.interior_walls.q": "Are there cracks wider than 1 cm?",
  "item.flooring.area": "Flooring",
  "item.flooring.q": "Is there buckling, displaced tiles, or new gaps where the floor meets the baseboards?",
  "item.plumbing.area": "Plumbing / gas",
  "item.plumbing.q": "Are there leaking, cracked, or separated pipes? Do you hear rushing water or smell gas? (If you smell gas, shut off the main valve)",
  "item.electrical.area": "Electrical",
  "item.electrical.q": "Are there tripped breakers, damaged outlets, or exposed wiring?",
  "item.fixtures.area": "Fixtures",
  "item.fixtures.q": "Are light fixtures hanging unevenly or junction boxes pulled apart by the shaking?",
  ...
  "item.walls.q": "Did new cracks appear in the walls (diagonal, X-shaped, or wider than your pinky finger)?",
  "item.walls.example.yes": "New diagonal or X-shaped cracks, or wide enough to fit your pinky finger.",
  "item.walls.example.no": "Only hairline lines, or no new cracks at all.",
  "item.columns.area": "Columns and beams",
  "item.columns.q": "Are there columns or beams with spalled (chipped) concrete, exposed rebar, or marked cracks?",
  "item.columns.example.yes": "Concrete on a column or beam chipped off and you can see the rebar, or it has strong cracks.",
  "item.columns.example.no": "Columns and beams are smooth, with no fallen concrete or visible steel.",
  "item.openings.area": "Doors and windows",
  "item.openings.q": "Are there doors or windows that no longer open or close because the frame warped?",
  "item.openings.example.yes": "A door or window that used to open now jams or won't close because the frame is distorted.",
  "item.openings.example.no": "Doors and windows open and close like always.",
  "item.tilt.area": "Lean / tilt",
  "item.tilt.q": "Does the building or any floor look leaning, tilted, or sunken compared to before?",
  "item.tilt.example.yes": "The building looks leaning or tilted, a floor is now crooked, or part of it sank.",
  "item.tilt.example.no": "The building is still straight and level, just like before the quake.",
  "checklist.severeTitle": "Other signs to check",
  "checklist.severeSubtitle": "Optional. If you saw any of these with this quake, check it. It helps us understand the case better. If you saw none, continue.",
  "checklist.severeNoneHint": "If you saw none, leave them unchecked and continue.",
  "checklist.required": "Required",
  "checklist.photosTitle": "Photos (required)",
  "checklist.photosIntro": "Photos are the most important part — they are the engineer's eyes. Without them they can't help you. Take sharp, well-lit, well-focused photos.",
  "checklist.facadeTitle": "Facade photos",
  "checklist.facadeHelp": "Add 1 to 5 photos of the whole building from the outside. If it doesn't fit in one shot, take it from several angles. It lets us see if it's leaning without going inside.",
  "checklist.facadeCount": "{n} of {max} photos",
  "checklist.damageTitle": "Damage photos",
  "checklist.damageHelp": "Add clear photos of what you saw. For each damage, one wide shot (the whole element) and one close-up. At least {min}, up to {max}.",
  ...
  "checklist.usefulIntro": "This is what a useful photo looks like. Take them thinking about what the engineer needs to see:",
  "checklist.usefulEx.scale.title": "With size reference",
  "checklist.usefulEx.scale.desc": "Put a hand, coin or ruler next to the crack so the width is clear.",
  "checklist.usefulEx.rebar.title": "Concrete and rebar exposed",
  "checklist.usefulEx.rebar.desc": "On columns and beams, show spalled concrete and exposed steel.",
  "checklist.usefulEx.joint.title": "Joints and corners",
  "checklist.usefulEx.joint.desc": "Where wall, column and roof meet is where real damage shows.",
  "checklist.usefulEx.wideClose.title": "Wide and close-up",
  "checklist.usefulEx.wideClose.desc": "The whole building from a distance (full facade) plus a close-up of the detail. The wide shot is the most useful one for the engineer.",
  ...
  "checklist.commentsHint": "Tell the engineer what the photos can't show — materials, when the damage appeared, anything unusual.",
  "checklist.commentsPlaceholder": "E.g.: The building is concrete block. A crack in the living room appeared right after the quake and keeps growing. Water is leaking from the ceiling.",
  "checklist.signalsTitle": "Mark what applies (optional)",
  "checklist.signalsHint": "This helps the engineer prioritize your case. Mark only what's true.",
  "checklist.suggest.aftershock": "There were strong aftershocks after the quake",
  "checklist.suggest.noises": "I hear new creaking or noises in the structure",
  "checklist.suggest.common": "There is damage in common areas (stairs, elevator, water tank, parking)",
  "checklist.suggest.people": "There are elderly people, children or people with reduced mobility in the building",
  "checklist.suggest.evacuated": "The building has already been evacuated or tagged by the authorities",
  ...
  "glossary.cimientos.def": "The base the whole building rests on, usually below the first floor.",
  "glossary.licuefaccion.term": "Liquefaction",
  "glossary.licuefaccion.def": "When water-saturated ground loses firmness during a quake and behaves like mud: water or sand can bubble up and structures sink or tilt.",
  "glossary.grieta_diagonal.term": "Diagonal crack",
  "glossary.grieta_diagonal.def": "A slanted, X-shaped or stair-step crack. Usually more serious than a thin straight crack because it points to structural stress.",
  "glossary.golpeteo.term": "Pounding",
  "glossary.golpeteo.def": "When two neighboring buildings collide during a quake because they sit too close together.",
  "glossary.columna.term": "Column",
  "glossary.columna.def": "A vertical element (usually concrete) that carries the building's weight.",
  "glossary.viga.term": "Beam",
  "glossary.viga.def": "A horizontal element that connects the columns and holds up floors and the roof.",
  "glossary.cabilla.term": "Rebar",
  "glossary.cabilla.def": "The steel bars inside concrete that reinforce it. If they're exposed, the damage is serious.",
  "glossary.pandeo.term": "Buckling",
  "glossary.pandeo.def": "When a surface that should be straight looks sunken, curved, or bulging.",
  "glossary.rodapie.term": "Baseboard",
  "glossary.rodapie.def": "The trim where the wall meets the floor. A new gap there can mean movement.",
  "glossary.breaker.term": "Breaker",
  "glossary.breaker.def": "The switch in the electrical panel that cuts power when there's a fault.",
  "glossary.tomacorriente.term": "Outlet",
  "glossary.tomacorriente.def": "The wall socket where you plug in appliances.",
  ...
  "property.age.pre1970.desc": "Older construction, before modern seismic codes.",
  "property.age.1970to2000.desc": "Late last-century construction.",
  "property.age.post2000.desc": "More recent construction.",
  "rule.urm.finding": "Unreinforced masonry building: highly vulnerable after strong shaking.",
  "rule.urm.step": "Suggestion: as a precaution, avoid staying inside until a licensed engineer or Civil Protection assess the building.",
  "rule.tilt.finding": "The building looks leaning, tilted, or sunken: possible collapse risk.",
  "rule.tilt.step": "Suggestion: do not stay inside; step out and report it to Civil Protection or a licensed engineer immediately.",
  "rule.liquefaction.finding": "Soil liquefaction signs: the ground lost its bearing capacity.",
  "rule.liquefaction.step": "Suggestion: the structure may settle or tilt; consider stepping out and reporting it to authorities for review.",
  "rule.pounding.finding": "Pounding with an adjacent building: possible severe structural damage.",
  "rule.pounding.step": "Suggestion: as a precaution, avoid the contact area between the buildings.",
  "rule.plumbing.finding": "Severe plumbing damage or possible gas leak: immediate hazard.",
  "rule.plumbing.step": "Suggestion: if you suspect a leak, shut off the main gas and water valves, avoid lights or flames, and consider stepping out.",
  "rule.intensity.finding": "Moderate shaking (intensity VI or acceleration ≥0.25g) at this location.",
  "rule.intensity.step": "Suggestion: increase caution, inspect more carefully, and prioritize a professional assessment.",
  "rule.intensity_severe.finding": "Very strong shaking (intensity VIII+ or acceleration ≥0.50g) at this location.",
  "rule.intensity_severe.step": "Suggestion: this area received some of the strongest shaking from the quake; treat any damage with maximum caution.",
  "rule.spectral.finding": "Seismic demand for buildings of this height was high (spectral acceleration ≥0.40g).",
  "rule.spectral.step": "Suggestion: buildings of this height felt the shaking especially hard; prioritize a professional review.",
  "rule.softsoil.finding": "Soft soil: amplifies shaking and raises liquefaction risk.",
  "rule.softsoil.step": "Suggestion: watch for ground or building settlement and tilting.",
  "rule.softsoil_severe.finding": "Very soft soil: strong shaking amplification and high liquefaction risk.",
  "rule.softsoil_severe.step": "Suggestion: inspect the ground and foundations carefully and prioritize a professional assessment.",
  "rule.combo_shaking.finding": "Very strong shaking combined with reported structural damage: critical life-safety risk.",
  "rule.combo_shaking.step": "Suggestion: as a precaution, avoid staying inside until a licensed engineer or Civil Protection confirm it.",
  "rule.floors.finding": "Building over 7 floors: extra caution required.",
  "rule.floors.step": "Suggestion: limit use until an engineer confirms the upper floors are safe.",
  "rule.structure.finding": "This building's structural system requires extra caution.",
  ...
  "analyze.savedHint": "Your answers are saved. You can wait even if the signal is slow.",
  "analyze.waitingTitle": "Waiting for connection",
  "analyze.waitingBody": "Your answers are saved. The analysis will run automatically when the connection returns.",
  "analyze.errorTitle": "The analysis could not be completed",
  "analyze.rateLimited": "Too many requests right now. Please wait a moment and try again.",
  "analyze.throttled": "You've reached the analysis limit for now. Please wait a bit before assessing another property.",
  "analyze.creditsError": "The AI service is temporarily unavailable. Please try again later.",
  "analyze.genericError": "Something went wrong during analysis. Check your connection and try again.",
  ...
  "result.red.tag": "Severe findings",
  ...
  "result.findingsDisclaimer": "This is NOT a verdict or certification. These are preliminary, referential visual findings based on what you reported. Only a licensed structural engineer or an official agency can determine whether the building is safe or habitable.",
  ...
  "building.note": "Structural problems often affect a whole building. Share your result with your neighbors and the building's administration or condo board so the structure can be assessed together.",
  ...
  "provisional.step.engineer": "Suggestion: there are findings in structural elements; request an in-person technical inspection soon.",
  ...
  "result.seismicContextHint": "Data from the USGS ShakeMap for this earthquake, at this location. 'Demand for this height' is the spectral acceleration at the building's estimated natural period.",
  "result.share": "Share",
  "result.copyLink": "Copy link",
  "result.copied": "Link copied!",
  "result.downloadPdf": "Download PDF",
  "result.newAssessment": "New assessment",
  "result.disclaimerShort": "Preliminary visual findings, not a verdict. Determining safety or habitability is up to a licensed structural engineer or an official agency.",
  ...
  "nav.officialLegal": "Official & legal",
  ...
  "footer.tagline": "Post-earthquake structural damage self-assessment. Free, no sign-up.",
  "footer.explore": "Explore",
  "footer.participate": "Get involved",
  "footer.resources": "Resources",
  "footer.note": "Anonymized, open data · Community-built open-source project · Made with ❤️ for Venezuela 🇻🇪",
  "footer.evaluate": "Evaluate",
  "footer.contact": "Contact",
  "contact.email": "contacto@evaluaya.app",
  "contact.subject": "Inquiry — EvalúaYa",
  "data.title": "Data room",
  "data.subtitle": "Explore structural damage reported across Venezuela. Anonymous, open data — built for authorities, media and response teams.",
  "data.mobileNote": "You're viewing a summary. Open the data room on a larger screen for filters, an expanded map and full analysis.",
  "data.openMap": "View full map",
  "data.filters": "Filters",
  "picker.mostAffected": "Areas with most reports",
  ...
  "dataroom.severityTitle": "Priority cases",
  ...
  "dataroom.narrativeArea": "Of {total} assessments, {pct}% report damage that needs an engineer's attention. {area} is the area with the most reports.",
  "dataroom.narrativeLow": "Of {total} assessments, most report no serious damage.",
  "data.dict.title": "How to read this data",
  "data.dict.intro": "Definitions for the terms on this page, so everyone reads the numbers the same way.",
  "data.dict.evaluacion.term": "Assessment",
  "data.dict.evaluacion.def": "A self-assessment submitted from the app. It is not the same as a unique building: one building may have several assessments (e.g. different apartments).",
  "data.dict.zonas.term": "Areas",
  "data.dict.zonas.def": "Number of distinct municipalities or states with at least one assessment.",
  ...
  "data.dict.serious.def": "Serious findings: possible damage to structural elements; a technical inspection is advisable soon.",
  ...
  "data.dict.seriousOrHigh.def": "The sum of assessments with findings at orange (serious) and red (severe) level: the cases to prioritize for a technical inspection. It is not the same as “Severe findings”, which counts only the red level.",
  "data.dict.verified.term": "Reviewed by evaluator",
  "data.dict.verified.def": "Assessments reviewed by a community volunteer evaluator, not just by the resident.",
  "data.dict.more": "See full methodology",
  "mapa.seeFullData": "View full data",
  "mapa.seeFullDataDesc": "Filters, trends and by-area analysis in the data room.",
  "feedback.title": "Send feedback",
  "feedback.subtitle": "Have an idea, a question, or found a problem? Tell us and help make EvalúaYa better.",
  "feedback.messageLabel": "Your message",
  "feedback.messagePlaceholder": "Write your comment, suggestion, or problem here…",
  ...
  "feedback.thanksBody": "We read every message. Your input helps make EvalúaYa more useful for everyone.",
  "feedback.backHome": "Back to home",
  "feedback.privacy": "We don't collect personal data. Your email is optional and only used to reply to you.",
  "feedback.promptTitle": "How was it?",
  "feedback.promptBody": "Share your thoughts to help improve the app.",
  "help.title": "Help",
  "help.subtitle": "Learn how to use EvalúaYa and find answers to common questions.",
  "help.quickStartTitle": "How to run an assessment",
  "help.step1Title": "1. Property info",
  "help.step1Desc": "Enter the address, building type, number of floors, and approximate age.",
  "help.step2Title": "2. Observe and report",
  "help.step2Desc": "Answer simple Yes / No / Unsure questions area by area and, if you can, add a photo.",
  "help.step3Title": "3. AI analysis",
  "help.step3Desc": "Get organized visual findings (Minor / Moderate / Serious / Severe) with a plain-language explanation and suggestions. It is not a verdict.",
  "help.step4Title": "4. Save & share",
  "help.step4Desc": "Download a PDF, share it on WhatsApp, or save it to reference later.",
  ...
  "help.faq.signupA": "No. You can assess your home without creating an account. If you'd like to save your reports for later, you can create an optional account with your email.",
  "help.faq.behalfQ": "Can I assess on behalf of someone else?",
  "help.faq.behalfA": "Yes. You can complete an assessment on behalf of a neighbor or relative (for example, someone staying in a shelter) using what you can observe or photos they send you.",
  "help.faq.offlineQ": "Does it work offline or with a weak signal?",
  "help.faq.offlineA": "Yes. You can fill out the checklist with low signal; your progress is saved on your device and the analysis is sent once you're back online.",
  "help.faq.resultsQ": "What do the result colors mean?",
  "help.faq.resultsA": "They describe visual findings, not a safety verdict. Green: minor findings. Yellow: moderate findings. Orange: serious findings. Red: severe findings. In all cases, determining safety or habitability is up to a licensed structural engineer or an official agency.",
  "help.faq.engineerQ": "Can I ask an evaluator to review my case?",
  "help.faq.engineerA": "Yes. When you finish your assessment you can send a free request. A community volunteer evaluator is notified and may contact you on WhatsApp to give guidance, at no cost. They do not issue expert verdicts.",
  "help.faq.privacyQ": "Is my data private?",
  "help.faq.privacyA": "Yes. The assessment is anonymous. We don't ask for your name or personal details to use the app.",
  "help.faq.saveQ": "How do I save and revisit my reports?",
  "help.faq.saveA": "On the results screen you can create an account with your email (passwordless magic link) to access your reports from “My reports” anytime.",
  "help.faq.photosQ": "Are photos required?",
  "help.faq.photosA": "No. Photos are optional, but they help make the analysis more accurate.",
  "help.faq.newDamageQ": "Which damage should I report?",
  "help.faq.newDamageA": "Report only new damage caused by the recent earthquake, not cracks or issues that existed before. This keeps the result focused on the current risk.",
  "help.faq.officialQ": "Does this replace an official inspection?",
  "help.faq.officialA": "No. EvalúaYa offers preliminary guidance and does not replace an inspection by a licensed structural engineer or Civil Protection.",
  "help.moreTitle": "Need more help?",
  "help.moreBody": "Reach out if you have a question that isn't covered here, or learn how we calculate results.",
  ...
  "home.seoTagline": "Know in 2 minutes whether your home is safe to enter after the quake.",
  ...
  "home.exploreDesc": "Check reports and assess your home based on your state.",
  ...
  "zona.intro": "See how {estado} is doing based on anonymous community reports, and assess your home for free, with no sign-up, in just a few minutes.",
  ...
  "zona.noData": "There are no reports in {estado} yet. Be the first to assess your home and help your community.",
  "zona.aboutTitle": "How is this data calculated?",
  "zona.aboutBody": "The figures are anonymous counts of self-assessments done in the app. We never show addresses, photos or personal data.",
  ...
  "zona.municipiosWithReportsHint": "Tap a municipality to see its reports in detail.",
  "municipio.eyebrow": "Municipality report",
  "municipio.h1Prefix": "Structural damage in",
  "municipio.intro": "Anonymous community reports in {municipio}, {estado}. Assess your home for free, with no sign-up, in just a few minutes.",
  "municipio.ctaPrefix": "Assess my home in",
  "municipio.totalReports": "Reports in the municipality",
  "municipio.lastReport": "Last report",
  "municipio.notEnough": "There aren't enough reports in {municipio} yet to show a summary. Be among the first to assess your home and help your community.",
  ...
  "property.locationHint": "We only use the area (state/municipality) for the community map. Your exact address is never shown.",
  ...
  "map.subtitle": "Anonymous reports aggregated by area. Addresses and photos are never shown.",
  ...
  "map.distribution": "Distribution by level",
  ...
  "map.storyIntro": "Scroll to see the story behind the data: how serious the damage is, how it's trending, and why.",
  "map.severityTitle": "How serious it is",
  "map.severityNeedAttention": "need urgent attention",
  "map.severityCaption": "Share of assessments at orange or red level: moderate-to-severe damage that needs an engineer.",
  "map.severityTopArea": "Area with most reports",
  "map.severityNone": "For now, most assessments show no serious damage.",
  "map.trendTitle": "Reports over time",
  "map.trendSubtitle": "Assessments per day (last 90 days), split by risk level.",
  ...
  "apiUsage.subtitle": "Usage of the public data API. Requests reaching the server — cached responses aren't counted, so this is a lower bound.",
  "apiUsage.live": "Live",
  ...
  "apiUsage.emptyHint": "When someone uses the open data API, usage will show up here.",
  "apiUsage.calls": "calls",
  "apiUsage.docsCta": "View the API",
  "photos.title": "Photo documentation",
  "photos.subtitle": "How much photo evidence backs the reports. Counts only — the photos are never shown.",
  ...
  "photos.coverageSubtitle": "Which structural elements are best documented with photos.",
  ...
  "map.whySubtitle": "The factors that show up most across assessments nationwide: flagged damage, building age and type, seismic intensity, and triggered safety rules.",
  "map.exportTitle": "Export and share",
  "map.exportSubtitle": "Take this data to an engineer, authority, or news outlet.",
  "result.shareWhatsapp": "Share on WhatsApp",
  "result.whatsappMessage": "I assessed my building's structural damage with EvalúaYa. Assess yours too, it's free:",
  "result.inviteTitle": "Help your community",
  "result.inviteBody": "Share EvalúaYa with your neighbors. The more people assess, the better we understand each area's damage.",
  ...
  "result.proBadgeDesc": "This report was reviewed by a community volunteer evaluator; it is not an expert verdict or certification.",
  "result.residentBadge": "Resident self-assessment",
  "result.shareOwnerTitle": "Is this for someone else?",
  "result.shareOwnerBody": "Share these findings with the owner or resident so they can seek a technical inspection.",
  "share.title": "Help spread EvalúaYa",
  "share.body": "Share it with your family and neighbors. The more people assess their homes, the better we understand each area's damage. ❤️",
  "share.whatsapp": "Share on WhatsApp",
  "share.copy": "Copy link",
  "share.copied": "Link copied!",
  "share.message": "Assess your home's earthquake damage with EvalúaYa — free, no sign-up, works on low signal: 🇻🇪",
  ...
  "inst.body": "If you represent a municipality, Civil Protection, an NGO or the private sector and need access to this data, leave your details.",
  ...
  "methodology.subtitle": "How we calculate the result and where our credibility comes from.",
  "methodology.maintainedBy": "This page is maintained by the EvalúaYa team to explain how the tool works. It may be updated as we improve the method.",
  "methodology.intro": "EvalúaYa combines proven safety rules with an AI support layer that summarizes your answers and photos to give quick guidance across four levels: 🟢 green, 🟡 yellow, 🟠 orange or 🔴 red. These are preliminary visual findings to help you decide your next step; they are not a verdict and do not replace an engineer. Here we explain each step so you can validate it before using or sharing it.",
  "methodology.layersTitle": "Two layers of analysis",
  "methodology.layersIntro": "Every assessment runs through two layers. The final result always takes the more severe of the two.",
  "methodology.layerA.title": "Layer 1 · Safety rules",
  "methodology.layerA.body": "Deterministic rules based on professional rapid-assessment practice. They always apply and can override the AI when there are clear life-safety hazards.",
  "methodology.red.title": "Force RED (do not enter)",
  "methodology.red.urm": "Unreinforced masonry: block or brick walls without a concrete structure.",
  "methodology.red.liquefaction": "Signs of soil liquefaction: sinking, cracks with mud or water.",
  "methodology.red.pounding": "Pounding between neighboring buildings during the quake.",
  "methodology.red.plumbing": "Severe plumbing or gas damage.",
  "methodology.red.combo": "Very strong shaking (MMI VIII+ or PGA ≥0.50g) together with reported structural damage.",
  "methodology.yellow.title": "Escalate to YELLOW (caution)",
  "methodology.yellow.intensity": "Moderate shaking at your location: intensity MMI VI+ or peak ground acceleration (PGA) ≥0.25g.",
  "methodology.yellow.soil": "Soft soil (low vs30), which amplifies shaking and raises liquefaction risk.",
  "methodology.yellow.floors": "Buildings taller than 7 floors.",
  "methodology.yellow.structure": "More vulnerable structural systems: concrete moment frames, infill walls, precast, or low-rise reinforced masonry.",
  "methodology.orange.title": "Escalate to ORANGE (you need an engineer soon)",
  "methodology.orange.urm": "Unreinforced masonry, even with no visible damage or strong shaking: because it is so brittle it needs a professional look soon.",
  "methodology.orange.severe": "Very strong shaking at your location (MMI VIII+ or PGA ≥0.50g), even without visible damage.",
  "methodology.orange.spectral": "High seismic demand for the building's height: spectral acceleration ≥0.40g at its estimated period.",
  "methodology.orange.soil": "Very soft soil (very low vs30), which strongly amplifies shaking and raises liquefaction risk.",
  "reclassify.orange.note": " Updated to Orange under the new 4-level scale: the reported structural items need an engineer's inspection.",
  "reclassify.updated": "Result updated from \u201C{from}\u201D to \u201C{to}\u201D under the new 4-level scale (🟢🟡🟠🔴), which better separates moderate from serious damage.",
  "methodology.layerB.title": "Layer 2 · AI support",
  "methodology.layerB.body": "Your answers and the photos you upload (facade and damage) are sent to an AI vision model that acts as an ATC-20-style rapid triage aid: it summarizes the visual findings and suggests next steps in plain language. It is a support layer, not a verdict: the AI is conservative and, when safety is uncertain, it does not choose green. It does not replace an engineer's inspection.",
  "methodology.checklistTitle": "What you observe and report",
  "methodology.checklistBody": "The process has 2 steps. In \u201CObserve and report\u201D you answer 4 main questions (walls, columns and beams, doors and windows, building tilt) and flag serious signs if present (soil liquefaction, pounding between buildings, plumbing or gas damage, roof and stairs). Photos are required: the facade (up to 5) and the damage (between 5 and 10). You can also add notes and optional utility details (floors, plumbing, electrical, hanging objects) that help the engineer.",
  ...
  "methodology.sourcesIntro": "Our logic is modeled on recognized public frameworks:",
  "methodology.source.atc20": "ATC-20 — Rapid post-earthquake building safety evaluation (the green/yellow/red placard concept).",
  "methodology.source.usgs": "USGS ShakeMap and the Modified Mercalli Intensity (MMI) scale for shaking intensity.",
  "methodology.source.urm": "Earthquake-engineering consensus on the vulnerability of unreinforced masonry and soft stories.",
  "methodology.source.ai": "AI vision model via the Lovable AI Gateway, used as support for preliminary triage. It is not a certifier and does not issue a verdict.",
  "methodology.limitsTitle": "Limits & shared responsibility",
  "methodology.limit.notCert": "This is NOT a certification or a verdict, and does not replace a licensed engineer or Civil Protection. These are preliminary visual findings to guide you.",
  "methodology.limit.surface": "It only assesses the visible things you report. It does not inspect hidden elements, buried foundations, or the inside of walls.",
  "methodology.limit.depends": "Result quality depends on your answers and the sharpness of the photos.",
  "methodology.limit.privacy": "No sign-up required. We only use the area (state/municipality) for the community map; we never show your exact address or your photos.",
  "methodology.engineersTitle": "For engineers",
  "methodology.engineersBody": "Want to validate the algorithm at the code level? Download the technical specification: it includes the deterministic rules, the seismic intensity interpolation (USGS ShakeMap), the exact AI model prompt, and the merge logic.",
  "methodology.specDownload": "Download technical spec (PDF)",
  "methodology.ctaTitle": "Ready to assess?",
  "methodology.cta": "Start assessment",
  "methodology.disclaimer": "In an emergency, call Civil Protection or emergency services.",
  "nav.volunteers": "Volunteer engineers",
  "nav.volunteersShort": "Volunteers",
  "connect.title": "Request a volunteer evaluator",
   "connect.subtitleRed": "Your findings are severe. Send your case and we'll share it with the community's volunteer evaluator network. It's a free community service.",
   "connect.subtitleOrange": "Your findings are serious. Send your case and we'll share it with the community's volunteer evaluator network. It's a free community service.",
   "connect.subtitleYellow": "Send your case and we'll share it with the community's volunteer evaluator network, who can help you interpret these findings. It's a free community service.",
   ...
   "connect.requestBody": "Leave your details and we'll share your case with registered volunteer evaluators in your area. If a volunteer is available, they'll reach out on WhatsApp. This is a community effort: we can't guarantee a response or a specific timeframe.",
   "connect.requestCta": "Send request",
   "connect.requestSending": "Sending…",
   "connect.requestDone": "We received your request! We'll email you when a volunteer takes your case. Save the tracking link we sent you.",
   "connect.requestError": "Could not send. Please try again.",
   "connect.trackCta": "Check my case status",
   "connect.yourName": "Your full name",
   "connect.namePlaceholder": "e.g. María Rodríguez",
   "connect.yourEmail": "Your email",
   "connect.emailPlaceholder": "e.g. maria@email.com",
   "connect.emailHint": "We'll send case updates and a link to track its status there.",
   ...
   "connect.privacy": "Your details are only shared with registered community volunteer evaluators. They're never published.",
  "connect.areEngineer": "Are you an engineer? Join as a volunteer",
  "track.title": "Track your request",
  "track.subtitle": "Here you can see the status of your case. Save this link to come back anytime.",
  "track.loading": "Loading status…",
  "track.notFound": "We couldn't find this request. Check the link we emailed you.",
  "track.location": "Location",
  "track.risk": "Findings level",
  "track.stage.received": "Request received",
  "track.stage.received.desc": "We shared your case with the volunteer evaluator network in your area.",
  "track.stage.claimed": "A volunteer took your case",
  "track.stage.claimed.desc": "A volunteer evaluator is handling it and may reach out on WhatsApp.",
  "track.stage.contacted": "The volunteer contacted you",
  "track.stage.contacted.desc": "The evaluator reached out to coordinate.",
  "track.stage.visited": "Review done",
  "track.stage.visited.desc": "The evaluator reviewed the reported situation.",
  "track.stage.resolved": "Case closed",
  "track.stage.resolved.desc": "The evaluator marked your case as handled.",
  "track.waiting": "No volunteer has taken it yet. This is a community effort, so response time may vary.",
  "track.confirmTitle": "Was your case resolved?",
  "track.confirmBody": "Tell us whether a volunteer already helped you. This helps us close the case or reopen it if you still need help.",
  "track.confirmYes": "Yes, I was helped",
  "track.confirmNo": "No, still waiting",
  "track.confirmedResolved": "Thanks for confirming. We marked your case as resolved.",
  ...
  "vol.subtitle": "A community initiative. When a family asks for help after their self-assessment, we share their case with the network of volunteer evaluators. If a volunteer is available in their area, they guide the family over a video call and, if needed, with an in-person visit. It's a free service and depends on community availability.",
  ...
  "vol.how3": "You receive requests from families who asked for help after their self-assessment. You guide them over a video call or WhatsApp and, when possible, with an in-person visit.",
  ...
  "vol.whatsapp": "WhatsApp",
  "vol.email": "Email",
  "vol.emailHint": "We need it to send you your access link once you're validated.",
  "vol.verifyTitle": "Professional registration",
  "vol.verifyHint": "To get to know each volunteer better, add your license number (CIV) and a document supporting your profession. It speeds up your approval.",
  ...
  "vol.credentialHint": "PDF or image (CIV ID, degree, work proof). Max 6 MB. Only our validation team can see it.",
  ...
  "vol.successBody": "We'll review your request and send you a private link to see requests in your area.",
  ...
  "vol.verifiedSubtitle": "Registered professionals and organizations that joined the community network.",
  "vol.verifiedEmptyTitle": "Be the first",
  "vol.verifiedEmptyBody": "No registered evaluators yet. Join today and you'll appear here once we validate your request.",
  ...
  "vol.residentNoteBody": "Complete your evaluation and, at the end, you can request a connection with a community volunteer evaluator.",
  ...
  "panel.proBody": "Support the resident with a follow-up evaluation. You'll answer the same questions and the report will be marked as reviewed by a volunteer evaluator on the map. It is not a verdict or a habitability certificate.",
  "panel.startPro": "Start support evaluation",
  "panel.invalid": "Invalid or unapproved link",
  "panel.invalidBody": "This link doesn't match an approved volunteer evaluator. If you think this is a mistake, contact us.",
  ...
  "panel.waResident": "Hi, I'm a community volunteer evaluator from EvalúaYa. I saw your request for guidance after your assessment. How can I help?",
  ...
  "admin.rotateConfirm": "This invalidates the volunteer's previous link and creates a new one. Continue?",
  ...
  "panel.reviewBody": "Leave your professional observations after guiding the resident. This marks the report as reviewed by a volunteer evaluator; it is not a verdict or a habitability certificate.",
  ...
  "panel.reviewDescargo": "I declare that my observations are advisory and voluntary, that they do not constitute an official verdict or a habitability certificate, and that the decision on safety rests with a formal inspection by a licensed structural engineer, FUNVISIS or Civil Protection.",
  ...
  "panel.remitBody": "Remind the resident they can show this report and your observations to the authorities to request the official assessment.",
  ...
  "dash.buildingsHint": "Structures with 2 or more evaluations. Useful for spotting a single building generating several alerts.",
  ...
  "dash.matchingProgressHint": "What the engineer reports after claiming a request.",
  ...
  "dash.worklistHint": "Filter and act on low-quality or unverified high-risk reports.",
  ...
  "dash.verificationHint": "Confirm assessments with engineers and close the loop on high-risk reports.",
  ...
  "vadmin.triageHint": "Requests at risk of stalling. Act to drive them to completion.",
  ...
  "seg.hint": "Urgent cases first (🔴/🟠). Assign an engineer or push to drive them to completion.",
  ...
  "account.saveBody": "Want to see this report later or from another phone? Get a link by email to save it. No password needed.",
  "account.saveHint": "We only use your email to send you the access link. No password, no spam. It's optional.",
  ...
  "account.checkEmailBody": "We sent you an access link. Open it on this phone or any other to see your saved reports.",
  "account.savedTitle": "Your reports are saved",
  "account.savedBody": "You're signed in. You can view your reports anytime.",
  "account.viewMyReports": "My reports",
  "account.myReportsTitle": "My reports",
  "account.signInBody": "Sign in with your email to see the reports you've saved.",
  "account.loading": "Loading your reports…",
  "account.emptyReports": "You don't have any saved reports in this account yet. Once you save a report, it will appear here.",
  "account.signOut": "Sign out",
  "account.claimToast": "Report saved to your account.",
  "dash.accounts": "Saved accounts",
  "dash.accountsHint": "People who saved their reports with their email (optional, passwordless account).",
  ...
  "privacy.subtitle": "How EvalúaYa collects, uses and protects your data. Written in plain language.",
  "privacy.updated": "Last updated: June 2026",
  "privacy.intro": "EvalúaYa is a free tool for self-assessing structural damage after an earthquake. You can run an assessment without signing up. This page explains what we collect and what we do with it.",
  "privacy.responsible.title": "Who is responsible",
  "privacy.responsible.body": "This application is operated by EvalúaYa.app. For any privacy question, write to contacto@evaluaya.app.",
  "privacy.collect.title": "What we collect",
  "privacy.collect.intro": "Depending on how you use the app, we may collect:",
  "privacy.collect.b1": "Your inspection answers and property details (building type, floors, age, building name).",
  "privacy.collect.b2": "Approximate location you enter: state, municipality and the address/neighborhood text.",
  "privacy.collect.b3": "Photos you choose to upload (optional). They are kept in private storage.",
  "privacy.collect.b4": "Your email only if you create an account to save reports, sign up as a volunteer, send feedback, or are an interested institution.",
  "privacy.collect.b5": "Basic technical data to prevent abuse (e.g. an IP address used temporarily for rate limiting).",
  "privacy.use.title": "How we use data",
  "privacy.use.intro": "We use the information to:",
  "privacy.use.b1": "Generate your result via automated structural analysis (AI) and safety rules.",
  "privacy.use.b2": "Create the report you can save, download as PDF and share.",
  "privacy.use.b3": "Produce anonymized, aggregated statistics for the map and data room.",
  "privacy.use.b4": "Connect residents who request it with a registered volunteer engineer.",
  "privacy.share.title": "What we share",
  "privacy.share.body": "Photos stay in private storage and are only accessed through temporary signed links. Public surfaces (map, data room, open API) show only anonymized, aggregated counts — never addresses, photos or report IDs. We do not sell your data.",
  "privacy.retention.title": "Retention",
  "privacy.retention.body": "We keep reports to maintain building history and aggregated statistics. You can request access to or deletion of your data via the contact email.",
  "privacy.processors.title": "Processors",
  "privacy.processors.body": "We rely on infrastructure providers for hosting, database, AI analysis and email delivery. They only process data to provide these services on our behalf.",
  "privacy.cookies.title": "Cookies and device storage",
  "privacy.cookies.body": "We store information on your device so the app works offline (drafts and the send queue) and to remember your language. We use basic analytics to understand app usage.",
  "privacy.rights.title": "Your rights",
  "privacy.rights.body": "You can request access, correction or deletion of your personal data, or remove your email, at any time by writing to contacto@evaluaya.app.",
  "privacy.contact.title": "Contact",
  "privacy.contact.body": "Privacy questions? Write to us at contacto@evaluaya.app.",
  "privacy.disclaimer": "EvalúaYa offers preliminary guidance and is not a substitute for inspection by a licensed structural engineer or Civil Protection.",
  "data.api.title": "Open data / API",
  "data.api.body": "We publish the anonymized, aggregated data as an open API for authorities, media, researchers and AI agents. Counts only — never addresses, photos or IDs.",
  "data.api.endpointsTitle": "Endpoints",
  ...
  "official.dir.subtitle": "Official numbers to request the official assessment of your building and for emergencies. Tap to call.",
  ...
  "official.dir.note": "EvalúaYa publishes these official numbers for direct dialing. It does not manage or take responsibility for these communications. As contingency information, it may change — please confirm before you go.",
  "official.pc_caracas.name": "Civil Protection — Caracas Government",
  "official.pc_caracas.desc": "Key contact to coordinate the assessment of residential and public infrastructure.",
  "official.ven911.name": "VEN 9-1-1",
  "official.ven911.desc": "Unified emergency service, operates 24 hours.",
  "official.pcivil.name": "Civil Protection — toll-free line",
  "official.pcivil.desc": "0800-PCIVIL1 · general contingencies and large-scale rescue.",
  "official.bomberos.name": "Caracas Fire Department",
  "official.bomberos.desc": "Fires, first aid and confinement in collapsed structures.",
  "official.cruzroja.name": "Red Cross",
  "official.cruzroja.desc": "Pre-hospital assistance, humanitarian support and locating people.",
  "official.funvisis.name": "FUNVISIS",
  "official.funvisis.desc": "0-800-TEMBLOR · free 24 h. CEDI Mon–Fri 8:00–12:00 and 1:00–4:00.",
  "official.civ.name": "Venezuelan Association of Engineers (CIV)",
  "official.civ.desc": "Guidance on certified specialists. Office: Av. Principal de Quebrada Honda, Los Caobos, Caracas.",
  "sos.title": "Imminent danger?",
  "sos.body": "If there is a threat to life — collapse, trapped people, gas smell — call immediately.",
  "sos.call911": "Call VEN 9-1-1",
  "sos.callPcivil": "Civil Protection 0800",
  "transparency.title": "This is not the official inspection",
  "transparency.body": "EvalúaYa is only a quick visual check (Phase 0). For the official assessment of your building, contact Civil Protection of the Caracas Government: (0212) 575-1823. In an emergency: VEN 9-1-1 or 0800-PCIVIL1. The official label is only placed by personnel certified by the authority.",
  "transparency.limits": "Even the official inspection does not guarantee safety against future events: situations beyond its scope may exist and stability conditions can change.",
  "transparency.cta": "See official contacts",
  "transparency.processCta": "Learn the official process",
  "transparency.remit": "You can show this report (and its PDF) to the authorities when requesting the official assessment. If a volunteer engineer reviews it, you can share their observations too — they help but do not replace the official inspection.",
  "pdf.officialTitle": "Official contacts",
  "pdf.officialIntro": "This is only a quick visual check, not the official inspection. Request the official assessment of your building:",
