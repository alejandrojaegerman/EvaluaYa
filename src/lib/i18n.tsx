...
const es: Dict = {
  ...
  "home.heroSubtitle": "Revisa los daños de tu casa en minutos con una guía paso a paso y conéctate con un ingeniero civil voluntario.",
  ...
  "engineers.validateDesc": "Revisamos su experiencia antes de aprobarlos y marcarlos como verificados.",
  "engineers.connect": "Conectamos",
  "engineers.connectDesc": "Cuando una familia lo solicita tras su autoevaluación, la enlazamos con un ingeniero voluntario verificado que la orienta por videollamada y, si hace falta, en persona. Sin costo.",
  "engineers.learnMore": "Únete como ingeniero voluntario",
  "engineers.mapNote": "Tras una evaluación, los residentes pueden pedir apoyo de un ingeniero voluntario verificado.",
  ...
  "engineers.methodologyBody": "La autoevaluación es el primer paso. Además, reclutamos y validamos a ingenieros voluntarios y organizaciones, y conectamos a los residentes que lo solicitan con un profesional verificado para confirmar o ajustar el resultado.",
  ...
  "checklist.usefulEx.wideClose.desc": "Una toma general para ubicar el daño y otra cercana del detalle.",
  ...
  "vol.verifyHint": "Para proteger a las familias, validamos a cada voluntario(a). Agrega tu número de colegiatura (CIV) y un documento que respalde tu profesión. Acelera tu aprobación.",
  ...
  "vol.verifiedSubtitle": "Profesionales y organizaciones que ya revisamos y se sumaron a la red comunitaria.",
  ...
  "privacy.use.b4": "Conectar a los residentes que lo solicitan con un ingeniero voluntario verificado.",
...
const en: Dict = {
  ...
  "home.heroSubtitle": "Review your home's damage in minutes with a step-by-step guide and connect with a volunteer civil engineer.",
