...
const en: Dict = {
  ...
  "home.behalfBody": "You don't have to be inside. A relative or neighbor can run the inspection for you and share the result so you can decide whether it's safe to enter.",
