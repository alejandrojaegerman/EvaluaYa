...
const en: Dict = {
  ...
  "engineers.validateDesc": "We review their experience before approving them and marking them verified.",
  "engineers.connect": "We connect",
  "engineers.connectDesc": "When a family asks after their self-assessment, we link them with a verified volunteer engineer who guides them over a video call — and in person if needed. At no cost.",
  "engineers.learnMore": "Become a volunteer engineer",
  "engineers.mapNote": "After an assessment, residents can request support from a verified volunteer engineer.",
  "engineers.footerDesc": "We recruit, validate and connect engineers.",
  "engineers.methodologyTitle": "Volunteer engineer network",
  "engineers.methodologyBody": "Self-assessment is the first step. We also recruit and validate volunteer engineers and organizations, and connect residents who request it with a verified professional to confirm or adjust the result.",
  ...
  "checklist.usefulEx.wideClose.desc": "One wide shot to locate the damage and one close-up of the detail.",
  ...
  "vol.verifyHint": "To protect families, we validate every volunteer. Add your license number (CIV) and a document supporting your profession. It speeds up your approval.",
  ...
  "vol.verifiedSubtitle": "Professionals and organizations we've reviewed who joined the community network.",
  ...
  "privacy.use.b4": "Connect residents who request it with a verified volunteer engineer.",
