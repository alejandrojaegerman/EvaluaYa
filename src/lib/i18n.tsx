...
const es: Dict = {
  ...
  "connect.requestBody": "Deja tu WhatsApp y compartiremos tu reporte con evaluadores voluntarios de la comunidad registrados. Uno de ellos tomará tu caso y te contactará.",
  ...
  "connect.privacy": "Tu número solo se comparte con evaluadores voluntarios de la comunidad registrados. No se publica.",
...
const en: Dict = {
  ...
  "connect.requestBody": "Leave your WhatsApp and we'll share your report with registered community volunteer evaluators. One of them will take your case and reach out.",
  ...
  "connect.privacy": "Your number is only shared with registered community volunteer evaluators. It's never published.",
