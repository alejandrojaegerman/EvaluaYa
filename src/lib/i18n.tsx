...
const es: Dict = {
  ...
  "admin.reqVerdictAgree": "Confirmó el riesgo de la IA",
  "admin.reqVerdictAdjust": "Ajustó el riesgo de la IA",
...
const en: Dict = {
  ...
  "admin.reqVerdictAgree": "Confirmed AI risk",
  "admin.reqVerdictAdjust": "Adjusted AI risk",
