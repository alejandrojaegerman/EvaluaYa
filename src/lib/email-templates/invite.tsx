...
export const InviteEmail = ({ confirmationUrl }: InviteEmailProps) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Te invitaron a EvalúaYa</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          <Heading style={h1}>Te invitaron a EvalúaYa</Heading>
          <Text style={text}>
            Recibiste una invitación para unirte a EvalúaYa. Toca el botón para
            aceptar y crear tu cuenta.
          </Text>
          ...
          <Hr style={hr} />
          <Text style={textEn}>
            <strong>In English:</strong> You've been invited to join EvalúaYa.
            Tap the button to accept and create your account. If you weren't
